...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/help-center-support.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:23 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="help-center-support.html" />
    <title>Help Center Support | Geeks - Bootstrap 5 Template</title>
  </head>
            ...
            <div class="offset-md-2 col-md-8 col-12">
              <div class="d-flex flex-column gap-3">
                <div class="d-flex flex-column gap-8">
                  <!-- lead  -->
                  <p class="lead mb-0">Can’t find the answer you’re looking for? Don't worry! Get in touch with the Docs Support team, we will be glad to assist you.</p>
                    ...
                    <div class="card-body p-5 d-flex flex-column gap-4">
                      ...
                      <form class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-select" data-choices="" id="selectSubject" required>
