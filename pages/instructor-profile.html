...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/instructor-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:27 GMT -->
<head>
        <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
        ...
        <link rel="canonical" href="instructor-profile.html" >
        <title>Instructor Profile | Geeks - Bootstrap 5 Template</title>
    </head>
  ...
  <div class="container-fluid px-0">
    ...
    <div class="collapse navbar-collapse" id="navbar-default">
      ...
      <form class="mt-3 mt-lg-0 me-lg-5 d-flex align-items-center">
        ...
        <main>
            <!-- Bg -->
            <div  style="background: url(../assets/images/background/profile-bg.jpg) no-repeat; background-position: center; height: 300px"></div>
            <!-- User info -->
            <section class="card p-lg-2 pt-2 pt-lg-0 rounded-0 border-0">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="d-flex align-items-center">
                                <div class="position-relative mt-n8">
                                    <img src="../assets/images/avatar/avatar-1.jpg" alt="avatar" class="rounded-circle avatar-xxl border-white border border-4 position-relative" >
                                    <a href="#" class="position-absolute top-0 end-0 me-2" data-bs-toggle="tooltip" data-placement="top" title="Verified">
                                ...
                                <div class="d-md-flex justify-content-between w-100 align-items-center">
                                    <div class="ms-3">
                                        <div class="d-flex align-items-center">
                                            <h3 class="mb-0 fw-bold me-2">Jenny Wilson</h3>
                                            <span class="badge bg-primary-soft">Instructor</span>
                                        </div>
                                        <span class="fs-6">Front-end Developer, Designer, Teacher</span>
                                    </div>
                                    <div class="d-flex text-center gap-3 ms-3 ms-md-0 my-3 my-md-0">
                        ...
                        <div class="col-lg-3 col-md-4 col-12">
                            ...
                            <div class="card border-0 mb-4">
                                ...
                                <div class="card-body">
                                    <h4>About me</h4>
                                    <p>
                                        I am an Innovation designer focussing on UX/UI based in Berlin. As a creative resident at Figma explored the city of the future and how new technologies like
                                        AI, voice control, and augmented reality will change our interfaces.
                                    </p>
                            ...
                            <div class="card border-0 mb-4 mb-lg-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                                        <div>
                                            <h4 class="mb-0 fw-bold">11,604</h4>
                                                    ...
                                                    <div class="d-lg-flex align-items-center">
                                                        ...
                                                        <div class="ms-lg-3 mt-2 mt-lg-0">
                                                            <h4 class="text-primary-hover">
                                                                ...
                                                                <span class="badge bg-success-soft">New</span>
                                                            </h4>
                                                            <ul class="list-inline fs-6 mb-0 text-inherit">
                                                                ...
                                                                <li class="list-inline-item">
                                                                    <span class="lh-1">
                                                                        <span class="fs-6 align-text-top">
                                                                            <svg
                                                ...
                                                <div>
                                                    ...
                                                    <span class="dropdown dropstart">
                                                        ...
                                                        <span class="dropdown-menu" aria-labelledby="courseDropdown">
                                                            ...
                                                            <a class="dropdown-item" href="#">
                                                                <span class="me-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-copy text-secondary " viewBox="0 0 16 16">
                                        ...
                                        <li class="list-group-item px-0 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <a href="#">
                                                    <div class="d-lg-flex align-items-center">
                                                        <div>
                                                            <img src="../assets/images/course/course-javascript.jpg" alt="course" class="rounded img-4by3-lg" >
                                                        </div>
                                                        <div class="ms-lg-3 mt-2 mt-lg-0">
                                                            <h4 class="text-primary-hover">JavaScript Fundamentals</h4>
                                                            <ul class="list-inline fs-6 mb-0 text-inherit">
                                                                <li class="list-inline-item">
                                                                    <span class="align-text-bottom">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                                                                    ...
                                                                    <span class="lh-1">
                                                                        <span class="fs-6 align-text-top">
                                                                            ...
                                                                            <svg
                                                                                ...
                                                                                height="9"
                                                                                fill="currentColor"
                                                                                class="bi bi-star-fill text-light"
                                                                                viewBox="0 0 16 16">
                                                                                <path
                                                                                    d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" >
                                                                            </svg>
                                                ...
                                                <div>
                                                    <!-- Dropdown -->
                                                    <span class="dropdown dropstart">
                                                        <a class="text-reset" href="#" role="button" id="courseDropdown1" data-bs-toggle="dropdown" data-bs-offset="-20,20" aria-expanded="true">
                                                            <i class="fe fe-more-vertical"></i>
                                                        </a>
                                        ...
                                        <li class="list-group-item px-0 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <a href="#">
                                                    <div class="d-lg-flex align-items-center">
                                                        <div>
                                                            <img src="../assets/images/course/course-angular.jpg" alt="course" class="rounded img-4by3-lg" >
                                                        </div>
                                                        <div class="ms-lg-3 mt-2 mt-lg-0">
                                                            <h4 class="text-primary-hover">AngularJS Forms Using Bootstrap</h4>
                                                            <ul class="list-inline fs-6 mb-0 text-inherit">
                                                                <li class="list-inline-item">
                                                                    <span class="align-text-bottom">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                                                ...
                                                <div>
                                                    <!-- Dropdown -->
                                                    <span class="dropdown dropstart">
                                                        <a class="text-reset" href="#" role="button" id="courseDropdown2" data-bs-toggle="dropdown" data-bs-offset="-20,20" aria-expanded="true">
                                                            <i class="fe fe-more-vertical"></i>
                                                        </a>
                                        ...
                                        <li class="list-group-item px-0 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <a href="#">
                                                    <div class="d-lg-flex align-items-center">
                                                        <div>
                                                            <img src="../assets/images/course/course-python.jpg" alt="course" class="rounded img-4by3-lg" >
                                                        </div>
                                                        <div class="ms-lg-3 mt-2 mt-lg-0">
                                                            <h4 class="text-primary-hover">Get start with Python from base</h4>
                                                            <ul class="list-inline fs-6 mb-0 text-inherit">
                                                                <li class="list-inline-item">
                                                                    <span class="align-text-bottom">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                                                ...
                                                <div>
                                                    <!-- Dropdown -->
                                                    <span class="dropdown dropstart">
                                                        <a class="text-reset" href="#" role="button" id="courseDropdown3" data-bs-toggle="dropdown" data-bs-offset="-20,20" aria-expanded="true">
                                                            <i class="fe fe-more-vertical"></i>
                                                        </a>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <a href="#">
                                                    <div class="d-lg-flex align-items-center">
                                                        ...
                                                        <div class="ms-lg-3 mt-2 mt-lg-0">
                                                            <h4 class="text-primary-hover">The Ultimate Advanced Laravel..</h4>
                                                            <ul class="list-inline fs-6 mb-0 text-inherit">
                                                                <li class="list-inline-item">
                                                                    <span class="align-text-bottom">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                                                ...
                                                <div>
                                                    <!-- Dropdown -->
                                                    <span class="dropdown dropstart">
                                                        <a class="text-reset" href="#" role="button" id="courseDropdown4" data-bs-toggle="dropdown" data-bs-offset="-20,20" aria-expanded="true">
                                                            <i class="fe fe-more-vertical"></i>
                                                        </a>
                                        ...
                                        <li class="list-group-item px-0 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <a href="#">
                                                    <div class="d-lg-flex align-items-center">
                                                        <div>
                                                            <img src="../assets/images/course/course-gatsby.jpg" alt="course" class="rounded img-4by3-lg" >
                                                        </div>
                                                        <div class="ms-lg-3 mt-2 mt-lg-0">
                                                            <h4 class="text-primary-hover">The Ultimate Advanced Gatsby Course..</h4>
                                                            <ul class="list-inline fs-6 mb-0 text-inherit">
                                                                <li class="list-inline-item">
                                                                    <span class="align-text-bottom">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                                                ...
                                                <div>
                                                    <!-- Dropdown -->
                                                    <span class="dropdown dropstart">
                                                        <a class="text-reset" href="#" role="button" id="courseDropdown5" data-bs-toggle="dropdown" data-bs-offset="-20,20" aria-expanded="true">
                                                            <i class="fe fe-more-vertical"></i>
                                                        </a>
                                        ...
                                        <li class="list-group-item px-0 pb-0 pt-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <a href="#">
                                                    <div class="d-lg-flex align-items-center">
                                                        <div>
                                                            <img src="../assets/images/course/course-css.jpg" alt="course" class="rounded img-4by3-lg" >
                                                        </div>
                                                        <div class="ms-lg-3 mt-2 mt-lg-0">
                                                            <h4 class="text-primary-hover">Learn CSS Language....</h4>
                                                            <ul class="list-inline fs-6 mb-0 text-inherit">
                                                                <li class="list-inline-item">
                                                                    <span class="align-text-bottom">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                                                ...
                                                <div>
                                                    <!-- Dropdown -->
                                                    <span class="dropdown dropstart">
                                                        <a class="text-reset" href="#" role="button" id="courseDropdown6" data-bs-toggle="dropdown" data-bs-offset="-20,20" aria-expanded="true">
                                                            <i class="fe fe-more-vertical"></i>
                                                        </a>
