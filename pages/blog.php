...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:10 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <title>Blog | Geeks - Bootstrap 5 Template</title>
  </head>
            ...
            <div class="offset-xl-2 col-xl-8 offset-lg-1 col-lg-10 col-md-12 col-12">
              ...
              <form class="row px-md-8 mx-md-8 needs-validation" novalidate>
                <div class="mb-3 col ps-0 ms-2 ms-md-0">
                  <label class="form-label visually-hidden" for="blogEmail">Email Address</label>
                  <input type="email" class="form-control" placeholder="Email Address" id="blogEmail" name="blogEmail" required />
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              <!-- Card -->
              <div class="card mb-4 shadow-lg card-lift">
                <a href="blog-single.html"><img src="../assets/images/blog/blogpost-1.jpg" class="card-img-top" alt="blogpost " /></a>
                <!-- Card body -->
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-danger">Tutorial</a>
                  <h3><a href="blog-single.html" class="text-inherit">What is PHP Function? For Beginner’s Guide</a></h3>
                  <p>Lorem ipsum dolor sit amet, accu msan in, tempor dictum nequrem ipsum...</p>
                  <!-- Row  -->
                  <div class="row align-items-center g-0 mt-4">
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              <!-- Card -->
              <div class="card mb-4 shadow-lg card-lift">
                <a href="blog-single.html"><img src="../assets/images/blog/blogpost-4.jpg" class="card-img-top" alt="blogpost " /></a>
                <!-- Card body-->
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-primary">Workshop</a>
                  <h3><a href="blog-single.html" class="text-inherit">What is Cyber Security? A Beginner’s Guide</a></h3>
                  <p>Lorem ipsum dolor sit amet, accu msan in, tempor dictum nequrem ipsum...</p>
                  <!-- Media content -->
                  <!-- Row -->
                  <div class="row align-items-center g-0 mt-4">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-danger">Tutorial</a>
                  <h3><a href="blog-single.html" class="text-inherit">What is machine learning and how does it work?</a></h3>
                  <p>Lorem ipsum dolor sit amet, accu msan in, tempor dictum nequrem ipsum...</p>
                  <!-- Media content -->
                  <div class="row align-items-center g-0 mt-4">
                    <div class="col-auto">
                      <img src="../assets/images/avatar/avatar-10.jpg" alt="avatar" class="rounded-circle avatar-sm me-2" />
                    </div>
                    <div class="col lh-1">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <div class="card-body">
                  ...
                  <p>Inventore pariatur veritatis maxime fugiat sint dolorem quas culpa officiis nemo quis!</p>
                  <!-- Media content -->
                  <!-- Row  -->
                  <div class="row align-items-center g-0 mt-4">
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <div class="card-body">
                  ...
                  <h3><a href="blog-single.html" class="text-inherit">How to become modern Stack Developer in 2020</a></h3>
                  <p>At beatae non sit dicta similique perspiciatis facilis veritatis quam. Recusandae, corrupti?</p>
                  <!-- Row  -->
                  <div class="row align-items-center g-0 mt-4">
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <!-- Card body -->
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-warning">Company</a>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-primary">Workshop</a>
                  <h3><a href="blog-single.html" class="text-inherit">How to become WebDesinger?</a></h3>
                  <!-- Media content -->
                  <p>Vero expedita voluptatibus cumque sunt ullam cum natus, vitae provident debitis pariatur?</p>
                  <!-- Row  -->
                  <div class="row align-items-center g-0 mt-4">
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12 d-none d-lg-block">
              <!-- Card -->
              <div class="card mb-4 shadow-lg card-lift">
                <a href="blog-single.html"><img src="../assets/images/blog/blogpost-2.jpg" class="img-fluid card-img-top" alt="blogpost " /></a>
                <!-- Card body -->
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-danger">Tutorial</a>
                  <h3><a href="blog-single.html" class="text-inherit">Developing Agile Leadership</a></h3>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:11 GMT -->
</html>
