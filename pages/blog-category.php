...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/blog-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:12 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="blog-category.html" />
    <title>Blog Category | Geeks - Bootstrap 5 Template</title>
  </head>
          ...
          <div class="row">
            <div class="offset-xl-2 col-xl-8 offset-lg-1 col-lg-10 col-md-12 col-12">
              <div class="text-center mb-5">
                <h1 class="display-2 fw-bold">Tutorial</h1>
              ...
              <form class="row px-md-8 mx-md-8 needs-validation" novalidate>
                <div class="mb-3 col ps-0 ms-2 ms-md-0">
                  <label class="form-label visually-hidden" for="blogCategoryEmail">Email Address</label>
                  <input type="email" class="form-control" placeholder="Email Address" name="blogCategoryEmail" id="blogCategoryEmail" required />
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <div class="card-body">
                  ...
                  <h3>
                    <a href="blog-single.html" class="text-inherit">How to become modern Stack Developer in 2020</a>
                  </h3>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-danger">Tutorial</a>
                  <h3>
                    <a href="blog-single.html" class="text-inherit">What is PHP Function? For Beginner’s Guide</a>
                  </h3>
                  <p>Lorem ipsum dolor sit amet, accu msan in, tempor dictum nequrem ipsum...</p>
                  <!-- Row  -->
                  <div class="row align-items-center g-0 mt-4">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-danger">Tutorial</a>
                  <h3>
                    <a href="blog-single.html" class="text-inherit">What is Cyber Security? A Beginner’s Guide</a>
                  </h3>
                  <p>Lorem ipsum dolor sit amet, accu msan in, tempor dictum nequrem ipsum...</p>
                  <!-- Media Content -->
                  <div class="row align-items-center g-0 mt-4">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12">
              ...
              <div class="card mb-4 shadow-lg card-lift">
                ...
                <div class="card-body">
                  <a href="#" class="fs-5 fw-semibold d-block mb-3 text-danger">Tutorial</a>
                  <h3>
                    <a href="blog-single.html" class="text-inherit">What is machine learning and how does it work?</a>
                  </h3>
                  <p>Lorem ipsum dolor sit amet, accu msan in, tempor dictum nequrem ipsum...</p>
                  <!-- Media Content -->
                  <div class="row align-items-center g-0 mt-4">
