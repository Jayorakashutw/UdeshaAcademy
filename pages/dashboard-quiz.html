...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard-quiz.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:04 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  ...
  <link rel="canonical" href="dashboard-quiz.html" />

  <title>Dashboard Quiz| Geeks - Bootstrap 5 Template</title>
                ...
                <div class="col-12">
                  ...
                  <div class="col-md-9 col-6">
                   ...
                   <div class="col-md-3 col-6">
                    <label class="form-label visually-hidden" for="selectTopics">Topics</label>
                   <select class="form-select"  data-choices="" name="selectTopics" id="selectTopics">
                   ...
                   <div class="card h-100">
                    ...
                    <div class="d-flex flex-row justify-content-between">
                      <div class=" d-flex flex-column gap-md-1 gap-2">
                        <h3 class="mb-0 ">
                            <a href="#!" class="text-inherit">HTML Basics Quiz</a>
                        </h3>
                            ...
                            <a href="#!">Web Development
                                <span class="align-text-top"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="7544f13f" clip-path="url(#c23d28ce)">
                                      ...
                                      <path id="038035a8" fill-rule="evenodd" clip-rule="evenodd" d="M12.0005 0.375C12.0005 0.275544 11.961 0.180161 11.8906 0.109835C11.8203 0.0395088 11.7249 0 11.6255 0L7.87547 0C7.77602 0 7.68063 0.0395088 7.61031 0.109835C7.53998 0.180161 7.50047 0.275544 7.50047 0.375C7.50047 0.474456 7.53998 0.569839 7.61031 0.640165C7.68063 0.710491 7.77602 0.75 7.87547 0.75H10.7202L4.60997 6.8595C4.57511 6.89437 4.54745 6.93576 4.52858 6.98131C4.50971 7.02687 4.5 7.07569 4.5 7.125C4.5 7.17431 4.50971 7.22313 4.52858 7.26869C4.54745 7.31424 4.57511 7.35563 4.60997 7.3905C4.64484 7.42537 4.68623 7.45302 4.73179 7.47189C4.77734 7.49076 4.82617 7.50047 4.87547 7.50047C4.92478 7.50047 4.97361 7.49076 5.01916 7.47189C5.06472 7.45302 5.10611 7.42537 5.14097 7.3905L11.2505 1.28025V4.125C11.2505 4.22446 11.29 4.31984 11.3603 4.39016C11.4306 4.46049 11.526 4.5 11.6255 4.5C11.7249 4.5 11.8203 4.46049 11.8906 4.39016C11.961 4.31984 12.0005 4.22446 12.0005 4.125V0.375Z" fill="#754FFE"></path>
                                    </g>
                                    <defs>
                                      <clipPath id="c23d28ce">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <p class="mb-0">Learn the basics of HTML, including tags, attributes, and structure.</p>
                        <ul class="mb-0 list-unstyled d-flex flex-column gap-2">
                            ...
                            <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                                ...
                                <span class="fw-medium">20 MCQs, 5 short answers.</span>
                            </li>
                        </ul>
                      <div>
                    ...
                    <div class="row gap-2 gap-md-0">
                      <div class="col-md-9 col-12">
                        <div class="d-flex flex-row gap-2 align-items-center">
                            <a href="student-quiz-start.html" class="btn btn-primary">Start Quiz</a>
                        ...
                        <span>Set Reminder</span></a>
                      </div>
                        </div>
                        <div class="col-md-3 col-12">
                        <div class="d-flex flex-row">
                            <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle" data-bs-toggle="tooltip" data-placement="top" title="info"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="78b9f696" clip-path="url(#e16d3067)">
                                  <path id="85627f1c" d="M8 15C6.14348 15 4.36301 14.2625 3.05025 12.9497C1.7375 11.637 1 9.85652 1 8C1 6.14348 1.7375 4.36301 3.05025 3.05025C4.36301 1.7375 6.14348 1 8 1C9.85652 1 11.637 1.7375 12.9497 3.05025C14.2625 4.36301 15 6.14348 15 8C15 9.85652 14.2625 11.637 12.9497 12.9497C11.637 14.2625 9.85652 15 8 15ZM8 16C10.1217 16 12.1566 15.1571 13.6569 13.6569C15.1571 12.1566 16 10.1217 16 8C16 5.87827 15.1571 3.84344 13.6569 2.34315C12.1566 0.842855 10.1217 0 8 0C5.87827 0 3.84344 0.842855 2.34315 2.34315C0.842855 3.84344 0 5.87827 0 8C0 10.1217 0.842855 12.1566 2.34315 13.6569C3.84344 15.1571 5.87827 16 8 16Z" fill="#64748B"></path>
                                  <path id="2e26e571" d="M8.92995 6.588L6.63995 6.875L6.55795 7.255L7.00795 7.338C7.30195 7.408 7.35995 7.514 7.29595 7.807L6.55795 11.275C6.36395 12.172 6.66295 12.594 7.36595 12.594C7.91095 12.594 8.54395 12.342 8.83095 11.996L8.91895 11.58C8.71895 11.756 8.42695 11.826 8.23295 11.826C7.95795 11.826 7.85795 11.633 7.92895 11.293L8.92995 6.588ZM8.99995 4.5C8.99995 4.76522 8.8946 5.01957 8.70706 5.20711C8.51952 5.39464 8.26517 5.5 7.99995 5.5C7.73474 5.5 7.48038 5.39464 7.29285 5.20711C7.10531 5.01957 6.99995 4.76522 6.99995 4.5C6.99995 4.23478 7.10531 3.98043 7.29285 3.79289C7.48038 3.60536 7.73474 3.5 7.99995 3.5C8.26517 3.5 8.51952 3.60536 8.70706 3.79289C8.8946 3.98043 8.99995 4.23478 8.99995 4.5Z" fill="#64748B"></path>
                                </g>
                                <defs>
                                  <clipPath id="e16d3067">
                                    <rect width="16" height="16" fill="white"></rect>
                                  </clipPath>
                                </defs>
                              </svg></a>
                              <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle" data-bs-toggle="tooltip" data-placement="top" title="link"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="ae3cbc2c">
                                  <path id="6e852b35" d="M4.71462 6.542L3.34262 7.914C2.77996 8.47666 2.46387 9.23978 2.46387 10.0355C2.46387 10.8312 2.77996 11.5943 3.34262 12.157C3.90528 12.7197 4.6684 13.0358 5.46412 13.0358C6.25984 13.0358 7.02296 12.7197 7.58562 12.157L9.41362 10.328C9.75292 9.98866 10.0059 9.57287 10.1512 9.11555C10.2966 8.65822 10.3301 8.1727 10.249 7.69974C10.1679 7.22677 9.97448 6.78016 9.68505 6.3974C9.39562 6.01464 9.0186 5.7069 8.58562 5.5L7.99962 6.086C7.94011 6.14558 7.88837 6.21245 7.84562 6.285C8.18015 6.38117 8.48379 6.56298 8.72651 6.81246C8.96924 7.06194 9.14266 7.37044 9.22962 7.70748C9.31658 8.04452 9.31408 8.39842 9.22235 8.73419C9.13063 9.06996 8.95286 9.37598 8.70662 9.622L6.87962 11.45C6.50434 11.8253 5.99535 12.0361 5.46462 12.0361C4.93389 12.0361 4.4249 11.8253 4.04962 11.45C3.67434 11.0747 3.46351 10.5657 3.46351 10.035C3.46351 9.50427 3.67434 8.99528 4.04962 8.62L4.84262 7.828C4.73042 7.40878 4.68719 6.9751 4.71462 6.542Z" fill="#64748B"></path>
                                  <path id="eed65994" d="M6.58556 4.6716C6.24627 5.01094 5.99333 5.42672 5.84797 5.88405C5.70261 6.34138 5.66909 6.8269 5.7502 7.29986C5.83131 7.77283 6.0247 8.21943 6.31413 8.60219C6.60356 8.98495 6.98059 9.2927 7.41356 9.4996L8.18856 8.7236C7.84951 8.63265 7.54036 8.45407 7.2922 8.2058C7.04403 7.95753 6.86557 7.64831 6.77477 7.30922C6.68397 6.97013 6.68402 6.61311 6.77491 6.27404C6.8658 5.93498 7.04433 5.62581 7.29256 5.3776L9.11956 3.5496C9.49484 3.17432 10.0038 2.96349 10.5346 2.96349C11.0653 2.96349 11.5743 3.17432 11.9496 3.5496C12.3248 3.92488 12.5357 4.43387 12.5357 4.9646C12.5357 5.49533 12.3248 6.00432 11.9496 6.3796L11.1566 7.1716C11.2686 7.5916 11.3116 8.0266 11.2846 8.4586L12.6566 7.0866C13.2192 6.52394 13.5353 5.76081 13.5353 4.9651C13.5353 4.16938 13.2192 3.40625 12.6566 2.8436C12.0939 2.28094 11.3308 1.96484 10.5351 1.96484C9.73934 1.96484 8.97622 2.28094 8.41356 2.8436L6.58556 4.6716Z" fill="#64748B"></path>
                                </g>
                              </svg></a>
                        </div>
                      </div>
                ...
                <div class="col-xxl-4 col-xl-6 col-12">
                    <div class="card h-100">
                     ...
                     <div class="d-flex flex-row justify-content-between">
                      <div class=" d-flex flex-column gap-md-1 gap-2">
                        <h3 class="mb-0 ">
                            <a href="#!" class="text-inherit">CSS Layouts and Styling</a>
                        </h3>
                        <div class="d-flex flex-md-row flex-column align-items-md-center gap-1 lh-1">
                             <span>Course</span>
                             <a href="#!">Web Development
                ...
                <div class="col-xxl-4 col-xl-6 col-12">
                    <div class="card h-100">
                     ...
                     <div class="d-flex flex-row justify-content-between">
                      <div class=" d-flex flex-column gap-md-1 gap-2">
                       <h3 class="mb-0 ">
                            <a href="#!" class="text-inherit">JavaScript Functions and Events</a>
                        </h3>
                        <div class="d-flex flex-md-row flex-column align-items-md-center gap-1 lh-1">
                             <span>Course</span>
                             <a href="#!">Program with JavaScript
                                 <span class="align-text-top"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                     <g id="7544f13f" clip-path="url(#c23d28ce)">
                                       <path id="f036e129" fill-rule="evenodd" clip-rule="evenodd" d="M6.477 2.625C6.477 2.52554 6.43749 2.43016 6.36717 2.35984C6.29684 2.28951 6.20146 2.25 6.102 2.25H1.125C0.826631 2.25 0.540483 2.36853 0.329505 2.5795C0.118526 2.79048 0 3.07663 0 3.375L0 10.875C0 11.1734 0.118526 11.4595 0.329505 11.6705C0.540483 11.8815 0.826631 12 1.125 12H8.625C8.92337 12 9.20952 11.8815 9.4205 11.6705C9.63147 11.4595 9.75 11.1734 9.75 10.875V5.898C9.75 5.79854 9.71049 5.70316 9.64017 5.63283C9.56984 5.56251 9.47446 5.523 9.375 5.523C9.27554 5.523 9.18016 5.56251 9.10983 5.63283C9.03951 5.70316 9 5.79854 9 5.898V10.875C9 10.9745 8.96049 11.0698 8.89017 11.1402C8.81984 11.2105 8.72446 11.25 8.625 11.25H1.125C1.02554 11.25 0.930161 11.2105 0.859835 11.1402C0.789509 11.0698 0.75 10.9745 0.75 10.875V3.375C0.75 3.27554 0.789509 3.18016 0.859835 3.10984C0.930161 3.03951 1.02554 3 1.125 3H6.102C6.20146 3 6.29684 2.96049 6.36717 2.89016C6.43749 2.81984 6.477 2.72446 6.477 2.625Z" fill="#754FFE"></path>
                                       <path id="038035a8" fill-rule="evenodd" clip-rule="evenodd" d="M12.0005 0.375C12.0005 0.275544 11.961 0.180161 11.8906 0.109835C11.8203 0.0395088 11.7249 0 11.6255 0L7.87547 0C7.77602 0 7.68063 0.0395088 7.61031 0.109835C7.53998 0.180161 7.50047 0.275544 7.50047 0.375C7.50047 0.474456 7.53998 0.569839 7.61031 0.640165C7.68063 0.710491 7.77602 0.75 7.87547 0.75H10.7202L4.60997 6.8595C4.57511 6.89437 4.54745 6.93576 4.52858 6.98131C4.50971 7.02687 4.5 7.07569 4.5 7.125C4.5 7.17431 4.50971 7.22313 4.52858 7.26869C4.54745 7.31424 4.57511 7.35563 4.60997 7.3905C4.64484 7.42537 4.68623 7.45302 4.73179 7.47189C4.77734 7.49076 4.82617 7.50047 4.87547 7.50047C4.92478 7.50047 4.97361 7.49076 5.01916 7.47189C5.06472 7.45302 5.10611 7.42537 5.14097 7.3905L11.2505 1.28025V4.125C11.2505 4.22446 11.29 4.31984 11.3603 4.39016C11.4306 4.46049 11.526 4.5 11.6255 4.5C11.7249 4.5 11.8203 4.46049 11.8906 4.39016C11.961 4.31984 12.0005 4.22446 12.0005 4.125V0.375Z" fill="#754FFE"></path>
                     ...
                     <div class="d-flex flex-column gap-3">
                         <p class="mb-0">Master JavaScript functions, event handling, and DOM interactions.</p>
                         <ul class="mb-0 list-unstyled d-flex flex-column gap-2">
                             <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                                 <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                     <span>
                                 ...
                                 <span class="fw-medium">17 Dec, 2024 18:00</span>
                             </li>
                             <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                                 <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                     <span>
                                 ...
                                 <span class="fw-medium">40 minutes</span>
                             </li>
                             <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                                 <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                     <span>
                ...
                <div class="col-xxl-4 col-xl-6 col-12">
                  <div class="card h-100">
                   ...
                   <div class="d-flex flex-row justify-content-between">
                    <div class=" d-flex flex-column gap-md-1 gap-2">
                      <h3 class="mb-0 ">
                          <a href="#!" class="text-inherit">React State Management</a>
                      </h3>
                      <div class="d-flex flex-md-row flex-column align-items-md-center gap-1 lh-1">
                           <span>Course</span>
                   ...
                   <div class="d-flex flex-column gap-3">
                       <p class="mb-0">Delve into state management concepts and tools like Redux in React.</p>
                       <ul class="mb-0 list-unstyled d-flex flex-column gap-2">
                           <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                               <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                   <span>
                               ...
                               <span class="fw-medium">18 Dec, 2024 18:00</span>
                           </li>
                           <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                               <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                   <span>
                               ...
                               <span class="fw-medium">50 minutes</span>
                           </li>
                           <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                               <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                   <span>
                               ...
                               <span class="fw-medium">30 MCQs</span>
                           </li>
                       </ul>
                     <div>
                       <span class="badge bg-light-subtle border rounded-pill text-secondary">Not Started</span>
              ...
              <div class="col-xxl-4 col-xl-6 col-12">
                  <div class="card h-100">
                   ...
                   <div class="d-flex flex-row justify-content-between">
                    <div class=" d-flex flex-column gap-md-1 gap-2">
                      <h3 class="mb-0 ">
                          <a href="#!" class="text-inherit">Python Data Structures</a>
                      </h3>
                      <div class="d-flex flex-md-row flex-column align-items-md-center gap-1 lh-1">
                           <span>Course</span>
                           <a href="#!">Programming with Python
                               <span class="align-text-top"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                   <g id="7544f13f" clip-path="url(#c23d28ce)">
                                     <path id="f036e129" fill-rule="evenodd" clip-rule="evenodd" d="M6.477 2.625C6.477 2.52554 6.43749 2.43016 6.36717 2.35984C6.29684 2.28951 6.20146 2.25 6.102 2.25H1.125C0.826631 2.25 0.540483 2.36853 0.329505 2.5795C0.118526 2.79048 0 3.07663 0 3.375L0 10.875C0 11.1734 0.118526 11.4595 0.329505 11.6705C0.540483 11.8815 0.826631 12 1.125 12H8.625C8.92337 12 9.20952 11.8815 9.4205 11.6705C9.63147 11.4595 9.75 11.1734 9.75 10.875V5.898C9.75 5.79854 9.71049 5.70316 9.64017 5.63283C9.56984 5.56251 9.47446 5.523 9.375 5.523C9.27554 5.523 9.18016 5.56251 9.10983 5.63283C9.03951 5.70316 9 5.79854 9 5.898V10.875C9 10.9745 8.96049 11.0698 8.89017 11.1402C8.81984 11.2105 8.72446 11.25 8.625 11.25H1.125C1.02554 11.25 0.930161 11.2105 0.859835 11.1402C0.789509 11.0698 0.75 10.9745 0.75 10.875V3.375C0.75 3.27554 0.789509 3.18016 0.859835 3.10984C0.930161 3.03951 1.02554 3 1.125 3H6.102C6.20146 3 6.29684 2.96049 6.36717 2.89016C6.43749 2.81984 6.477 2.72446 6.477 2.625Z" fill="#754FFE"></path>
                                     <path id="038035a8" fill-rule="evenodd" clip-rule="evenodd" d="M12.0005 0.375C12.0005 0.275544 11.961 0.180161 11.8906 0.109835C11.8203 0.0395088 11.7249 0 11.6255 0L7.87547 0C7.77602 0 7.68063 0.0395088 7.61031 0.109835C7.53998 0.180161 7.50047 0.275544 7.50047 0.375C7.50047 0.474456 7.53998 0.569839 7.61031 0.640165C7.68063 0.710491 7.77602 0.75 7.87547 0.75H10.7202L4.60997 6.8595C4.57511 6.89437 4.54745 6.93576 4.52858 6.98131C4.50971 7.02687 4.5 7.07569 4.5 7.125C4.5 7.17431 4.50971 7.22313 4.52858 7.26869C4.54745 7.31424 4.57511 7.35563 4.60997 7.3905C4.64484 7.42537 4.68623 7.45302 4.73179 7.47189C4.77734 7.49076 4.82617 7.50047 4.87547 7.50047C4.92478 7.50047 4.97361 7.49076 5.01916 7.47189C5.06472 7.45302 5.10611 7.42537 5.14097 7.3905L11.2505 1.28025V4.125C11.2505 4.22446 11.29 4.31984 11.3603 4.39016C11.4306 4.46049 11.526 4.5 11.6255 4.5C11.7249 4.5 11.8203 4.46049 11.8906 4.39016C11.961 4.31984 12.0005 4.22446 12.0005 4.125V0.375Z" fill="#754FFE"></path>
                   ...
                   <div class="d-flex flex-column gap-3">
                       <p class="mb-0">Understand Python data structures, including lists, tuples, and dictionaries.</p>
                       <ul class="mb-0 list-unstyled d-flex flex-column gap-2">
                           <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                               <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                   <span>
                               ...
                               <span class="fw-medium">19 Dec, 2024 18:00</span>
                           </li>
                           <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                               <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                   <span>
                               ...
                               <span class="fw-medium">60 minutes</span>
                           </li>
                           <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                               <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                   <span>
                               ...
                               <span class="fw-medium">35 MCQs</span>
                           </li>
                       </ul>
                     <div>
                       <span class="badge bg-light-subtle border rounded-pill text-secondary">Not Started</span>
              ...
              <div class="col-xxl-4 col-xl-6 col-12">
                  <div class="card">
                   ...
                   <div class="d-flex flex-row justify-content-between">
                    <div class=" d-flex flex-column gap-md-1 gap-2">
                      <h3 class="mb-0 ">
                          <a href="#!" class="text-inherit">Vue Directives and Components</a>
                      </h3>
                      <div class="d-flex flex-md-row flex-column align-items-md-center gap-1 lh-1">
                           <span>Course</span>
                           <a href="#!">Frontend Frameworks
                   ...
                   <div class="d-flex flex-column gap-3">
                       <p class="mb-0">Learn Vue's directives, components, and data binding techniques.</p>
                       <ul class="mb-0 list-unstyled d-flex flex-column gap-2">
                           <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                               <span class="d-flex flex-row gap-2 align-items-center lh-1">
                                   <span>
                           ...
                           <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                               ...
                               <span class="fw-medium">20 MCQs</span>
                           </li>
                       </ul>
                     <div>
                       <span class="badge bg-light-subtle border rounded-pill text-secondary">Not Started</span>
