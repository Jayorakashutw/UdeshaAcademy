...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/profile-privacy.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:49 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="profile-privacy.html" />
  ...
  <nav class="navbar navbar-expand-lg sidenav sidenav-navbar">
    ...
    <div class="db-content">
      <div class="container mb-4">
        <div class="row mb-5">
          <div class="col-12">
            <h1 class="h2 mb-0">Profile Privacy</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <p class="mb-0">Making your profile public allow other users to see what you have been learning on Geeks.</p>
              </div>
              <!-- Card body -->
              <div class="card-body">
