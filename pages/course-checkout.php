...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/course-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:47:59 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
                  ...
                  <div class="card-body">
                    <div class="row g-3">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="courseCheckoutFname" name="courseCheckoutFname" class="form-control" placeholder="First Name" required />
                        <div class="invalid-feedback">Please enter first name.</div>
                      </div>
                      <!-- Last name  -->
                      <div class="col-12 col-md-6">
                        <label class="form-label" for="courseCheckoutLname">Last Name</label>
                        <input type="text" id="courseCheckoutLname" name="courseCheckoutLname" class="form-control" placeholder="Last Name" required />
                      ...
                      <div class="col-12 col-md-12">
                        ...
                        <input type="text" id="courseCheckoutPhone" class="form-control" placeholder="Phone" name="courseCheckoutPhone" required />
                        <div class="invalid-feedback">Please enter Phone Number.</div>
                      </div>
                      <!-- Address  -->
                      <div class="col-12 col-md-12">
                        <label class="form-label" for="courseCheckoutAddress1">Address Line 1</label>
                        <input type="text" id="courseCheckoutAddress1" class="form-control" placeholder="Address" name="courseCheckoutAddress1" required />
                      ...
                      <div class="col-12 col-md-12">
                        ...
                        <input type="text" id="courseCheckoutAddress2" name="courseCheckoutAddress2" class="form-control" placeholder="Address" required />
                        <div class="invalid-feedback">Please enter first Address.</div>
                      </div>
                      <!-- State -->
                      <div class="col-12 col-md-4">
                        <label class="form-label" for="courseCheckoutState">State</label>
                        <select class="form-select" data-choices="" id="courseCheckoutState" required>
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <select class="form-select" data-choices="" id="courseCheckoutCountry" name="courseCheckoutCountry" required>
                      ...
                      <!-- Zip code  -->
                      <div class="col-12 col-md-4">
                        <label class="form-label" for="courseCheckoutZipcode">Zip/Postal Code</label>
                        <input type="text" id="courseCheckoutZipcode" class="form-control" name="courseCheckoutZipcode" placeholder="Zip" required />
                        <div class="invalid-feedback">Please enter post code.</div>
                      </div>
                      <div class="col-12">
                        <!-- Checkbox  -->
                        <div class="form-check">
                          <input type="checkbox" class="form-check-input" name="courseCheckoutShipping" id="courseCheckoutShipping" required />
                          <label class="form-check-label" for="courseCheckoutShipping">Shipping address is the same as my billing address</label>
                        </div>
                        <!-- Checkbox  -->
                        <div class="form-check">
                          <input type="checkbox" class="form-check-input" name="courseCheckoutInformation" id="courseCheckoutInformation" required />
                          <label class="form-check-label" for="courseCheckoutInformation">Save this information for next time</label>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row g-3" id="cardpayment">
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <select class="form-select" data-choices="" id="courseCheckoutMonth" name="courseCheckoutMonth" required>
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <select class="form-select" data-choices="" id="courseCheckoutYear" required>
                      ...
                      <div class="col-12 col-md-4">
                        <label for="digit-mask" class="form-label">
                          CVV Code
                          <i class="fe fe-help-circle ms-1 fs-6" data-bs-toggle="tooltip" data-placement="right" title="A 3 - digit number, typically printed on the back of a card."></i>
                        </label>
                      ...
                      <div class="col-12">
                        ...
                        <input id="courseCheckoutName" type="text" class="form-control" name="courseCheckoutName" placeholder="Name" required />
                      ...
                      <div class="mb-3 col-6">
                        ...
                        <select class="form-select" data-choices="" id="courseCheckoutCountry2" name="courseCheckoutCountry2" required>
                      ...
                      <div class="col-12 mb-5">
                        <div class="form-check">
                          <input type="checkbox" class="form-check-input" id="courseCheckoutRemember" required />
                          <label class="form-check-label" for="courseCheckoutRemember">Remember this card</label>
                        </div>
                      </div>
                    ...
                    <div id="internetpayment" class="row g-3">
                      <div class="col-12 mt-6">
                        ...
                        <input type="email" id="courseCheckoutPaypal" name="courseCheckoutPaypal" placeholder="Enter your PayPal email" class="form-control" required />
                      </div>
                      <div class="col-12 mt-6">
                ...
                <div class="card-body">
                  ...
                  <form>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="courseCheckoutApply" name="courseCheckoutApply" placeholder="Enter your code" aria-describedby="couponCode" />
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/course-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:00 GMT -->
</html>
