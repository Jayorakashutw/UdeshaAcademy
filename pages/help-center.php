...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/help-center.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:22 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="help-center.html" />
    <title>Help Center | Geeks - Bootstrap 5 Template</title>
  </head>
...
<nav class="navbar navbar-expand navbar-transparent shadow-none">
    <div class="container px-0">
        <div class="d-flex align-items-center">
            <a class="navbar-brand me-4" href="../index-2.html"><img src="../assets/images/brand/logo/logo.svg" alt="Geeks" /></a>
    ...
    <div class="ms-auto d-flex align-items-center">
        ...
        <div class="d-flex align-items-center">
            <a href="#" class="ms-2 me-md-4 text-dark" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                <i class="fe fe-search fs-3"></i>
            </a>
            <a href="help-center-support.html" class="btn btn-primary d-lg-block d-none">Submit Ticket</a>
        </div>
    </div>
    <!-- Collapse -->
</nav>
                ...
                <div class="d-flex flex-column gap-2">
                  <div class="pe-md-6">
                    ...
                    <form class="d-flex align-items-center">
                      ...
                      <!-- input  -->
                      <input type="search" id="SearchHelp" class="form-control ps-6 border-0 py-3 smooth-shadow-md" placeholder="Enter a question, topic or keyword" />
                    </form>
                  </div>
              ...
              <div class="col-md-4 col-12 border-end-md">
                ...
                <div class="border-bottom border-bottom-md-0 mb-3 mb-lg-0">
                  <div class="p-5">
                    ...
                    <!-- heading  -->
                    <h3 class="fw-semibold"><a href="help-center-faq.html" class="text-inherit">FAQs</a></h3>
                    <!-- para  -->
              ...
              <div class="col-md-4 col-12 border-end-md">
                ...
                <div class="border-bottom border-bottom-md-0 mb-3 mb-lg-0">
                  <div class="p-5">
                    ...
                    <!-- heading  -->
                    <h3 class="fw-semibold"><a href="help-center-guide.html" class="text-inherit">Guides & Resources</a></h3>
                    <!-- para  -->
              ...
              <div class="col-md-4 col-12">
                <div>
                  <div class="p-5">
                    ...
                    <!-- heading  -->
                    <h3 class="fw-semibold"><a href="help-center-support.html" class="text-inherit">Support</a></h3>
                    <!-- para  -->
                    <p>The good news is that youre not alone, and youre in the right place. Contact us for more detailed support.</p>
                    <!-- button  -->
          ...
          <div class="row">
            <div class="offset-lg-2 col-lg-6 col-12">
              <div class="mb-8 pe-lg-8">
                ...
                <p class="lead">Here are the most frequently asked questions you may check before getting started</p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="offset-lg-2 col-lg-8 col-12">
              ...
              <div class="accordion accordion-flush" id="accordionExample">
                <div class="border p-3 rounded-3 mb-2" id="headingOne">
                  <h3 class="mb-0 fs-4">
                    <a href="#" class="d-flex align-items-center text-inherit" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="pt-2">
                      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fuga aperiam velit possimus! Voluptatum aliquid minima dolorum, enim perspiciatis sit. Distinctio quidem perferendis
                      reprehenderit quisquam cum natus id, iusto, aut, quasi modi nihil veritatis! Possimus eum beatae dolor rem quidem libero sit odio quia eius ullam.
                    </div>
                  </div>
                </div>
                <!-- Card  -->
                ...
                <div class="border p-3 rounded-3 mb-2" id="headingTwo">
                  ...
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="pt-3">
                      Velit nisi libero modi, repellat quo ducimus eos saepe totam architecto doloremque earum commodi. Porro labore, accusantium totam eius unde quam obcaecati cum ut animi voluptatum
                      iste sit veritatis minima reiciendis aliquid reprehenderit praesentium autem ipsa molestias quod dolores.
                    </div>
                  </div>
                </div>
                <!-- Card  -->
                ...
                <div class="border p-3 rounded-3 mb-2" id="headingThree">
                  ...
                  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="pt-3">
                      Necessitatibus alias at labore explicabo totam illum saepe error delectus excepturi. Dolorem vitae eaque magnam quidem optio explicabo ipsa quae in nisi aut voluptates ratione
                      cumque dignissimos non at voluptatum quis soluta, modi dolorum nesciunt porro praesentium corporis commodi doloremque.
                      <br />
                      <br />
                      Architecto eaque vitae quaerat quo in, voluptas earum hic repudiandae assumenda, incidunt, mollitia numquam illo saepe impedit!
                    </div>
                  </div>
                </div>
                <!-- Card  -->
                ...
                <div class="border p-3 rounded-3 mb-2" id="headingFour">
                  <h3 class="mb-0 fs-4">
                    <a href="#" class="d-flex align-items-center text-inherit" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                  ...
                  <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                    <div class="pt-3">
                      Tenetur rem error, voluptatem fugit iusto laudantium laborum at molestias dolorum sint facilis voluptas alias soluta consequuntur. Id saepe officiis voluptates sit fuga repellat
                      facilis tempore vel explicabo unde, dicta, natus, amet repellendus ea reprehenderit! Perspiciatis non modi beatae vel est. Nisi?
                    </div>
                  </div>
                </div>
                <div class="border p-3 rounded-3 mb-2" id="headingFive">
                  <h3 class="mb-0 fs-4">
                    <a href="#" class="d-flex align-items-center text-inherit" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                ...
                <div class="border p-3 rounded-3 mb-2" id="headingSix">
                  <h3 class="mb-0 fs-4">
                    <a href="#" class="d-flex align-items-center text-inherit" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                ...
                <div class="border p-3 rounded-3 mb-2" id="headingSeven">
                  <h3 class="mb-0 fs-4">
                    <a href="#" class="d-flex align-items-center text-inherit" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                ...
                <div class="col-md-6 col-12">
                  ...
                  <div class="card border mb-md-0 mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <p>Geeks is here to help. We can provide you with the support you need. Just contact us and our team will reply quick to you.</p>
                      <!-- btn  -->
                ...
                <div class="col-md-6 col-12">
                  ...
                  <div class="card border">
                    ...
                    <div class="card-body">
                      ...
                      <!-- btn  -->
                      <a href="help-center-support.html" class="btn btn-outline-secondary btn-sm">Submit a Ticket</a>
                    </div>
                  </div>
                </div>
              </div>
