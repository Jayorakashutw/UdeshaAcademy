...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/course-single-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:47:58 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <title>Course Single v3 | Geeks - Bootstrap 5 Template</title>
  </head>
              ...
              <div class="d-flex flex-column gap-5">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Figma</li>
                  </ol>
                </nav>
              </div>
            </div>
              ...
              <div class="d-flex flex-column gap-5 product-content">
                <div class="d-flex flex-column gap-5">
                  <div class="d-flex flex-column gap-2">
                    <h1 class="mb-0 display-4">Figma UI UX Design Course for the Beginner</h1>
                    <p class="mb-0 lead text-gray-600">Use Figma to get a job in UI Design, User Interface, User Experience design, UX Design & Web Design</p>
                  </div>
                  <div class="d-flex flex-column gap-lg-3 gap-2">
                    <div class="d-flex flex-lg-row flex-column gap-2 gap-md-3 align-items-lg-center">
                      ...
                      <span class="d-flex flex-row gap-2 align-items-center">
                        ...
                        <span class="text-secondary">Last updated 07/2024</span>
                      </span>
                    </div>
                ...
                <div class="d-flex flex-column gap-3">
                  ...
                  <div class="accordion-single border" id="accordionExample">
                    <div class="accordion-item-single rounded-0">
                      <div class="accordion-header-single">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                          <a class="h4 mb-0" data-bs-toggle="collapse" href="#collapseOne" role="button" aria-expanded="false" aria-controls="collapseOne">
                    ...
                    <div class="accordion-item rounded-0">
                      <div class="accordion-header-single">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                          <a class="h4 mb-0" data-bs-toggle="collapse" href="#collapseTwo" role="button" aria-expanded="false" aria-controls="collapseTwo">
                            <div class="d-flex align-items-center gap-3 flex-row">
                              <div>
                                <span class="chevron-arrow">
                                  <i class="fe fe-chevron-down fs-4"></i>
                              ...
                              <div class="">
                                <div class="">Wireframing - Low Fidelity</div>
                              </div>
                            </div>
                          </a>
                          <span class="d-flex flex-row gap-2 d-none d-md-block">
                            <span class="text-secondary fw-medium">2 lectures</span>
                            <span class="text-secondary fw-medium">10min</span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="accordion-item rounded-0">
                      <div class="accordion-header-single">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                          <a class="h4 mb-0" data-bs-toggle="collapse" href="#collapseThree" role="button" aria-expanded="false" aria-controls="collapseThree">
                            <div class="d-flex align-items-center gap-3 flex-row">
                              <div>
                                <span class="chevron-arrow">
                                  <i class="fe fe-chevron-down fs-4"></i>
                              ...
                              <div class="">
                                <div class="">Basic Tools in Figma (Part-02)</div>
                              </div>
                            </div>
                          </a>
                          <span class="d-flex flex-row gap-2 d-none d-md-block">
                    ...
                    <div class="accordion-item rounded-0">
                      <div class="accordion-header-single">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                          <a class="h4 mb-0" data-bs-toggle="collapse" href="#collapseFour" role="button" aria-expanded="false" aria-controls="collapseFour">
                            <div class="d-flex align-items-center gap-3 flex-row">
                              <div>
                                <span class="chevron-arrow">
                                  <i class="fe fe-chevron-down fs-4"></i>
                              ...
                              <div class="">
                                <div class="">Designing a Travel Website (Beginner Projects).</div>
                              </div>
                            </div>
                          </a>
                          <span class="d-flex flex-row gap-2 d-none d-md-block">
                            <span class="text-secondary fw-medium">5 lectures</span>
                            <span class="text-secondary fw-medium">15min</span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="accordion-item rounded-0 mb-n1">
                      <div class="accordion-header-single">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                          <a class="h4 mb-0" data-bs-toggle="collapse" href="#collapseFive" role="button" aria-expanded="false" aria-controls="collapseFive">
                            <div class="d-flex align-items-center gap-3 flex-row">
                              <div>
                                <span class="chevron-arrow">
                                  <i class="fe fe-chevron-down fs-4"></i>
                              ...
                              <div class="">
                                <div class="">Tips & Tricks</div>
                              </div>
                            </div>
                          </a>
                          <span class="d-flex flex-row gap-2 d-none d-md-block">
                            <span class="text-secondary fw-medium">1 lectures</span>
                            <span class="text-secondary fw-medium">8min</span>
                          </span>
                        </div>
                      </div>
                ...
                <div class="d-flex flex-column gap-3">
                  <h2 class="mb-0">What you’ll get out of this course</h2>
                  <div class="border rounded-3 p-4">
                    <ul class="list-unstyled mb-0 d-flex flex-column gap-2">
                      ...
                      <li class="d-flex flex-row gap-2">
                        ...
                        <span>Identify the fundaments of composing a successful clo se.</span>
                      </li>
                      <li class="d-flex flex-row gap-2">
                        <span>
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill text-success" viewBox="0 0 16 16">
                ...
                <div class="d-flex flex-column gap-3">
                  <h2 class="mb-0">This course includes:</h2>
                  <div class="border rounded-3 p-4">
                    <div class="row gy-2">
                      <div class="col-lg-6">
                        <ul class="list-unstyled mb-0 d-flex flex-column gap-2">
                          <li class="d-flex flex-row gap-2">
                            <span>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_7767_6768)">
                                  <path
                                    d="M12.5 8.33331L16.2942 6.43664C16.4212 6.37317 16.5623 6.34321 16.7042 6.3496C16.846 6.35599 16.9839 6.39852 17.1047 6.47315C17.2255 6.54778 17.3252 6.65204 17.3944 6.77604C17.4636 6.90003 17.4999 7.03965 17.5 7.18164V12.8183C17.4999 12.9603 17.4636 13.0999 17.3944 13.2239C17.3252 13.3479 17.2255 13.4522 17.1047 13.5268C16.9839 13.6014 16.846 13.644 16.7042 13.6504C16.5623 13.6567 16.4212 13.6268 16.2942 13.5633L12.5 11.6666V8.33331Z"
                                    stroke="#754FFE"
                          ...
                          <li class="d-flex flex-row gap-2">
                            <span>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_7767_6774)">
                                  <path
                                    d="M2.5 15.8333C3.64014 15.175 4.93347 14.8285 6.25 14.8285C7.56652 14.8285 8.85986 15.175 10 15.8333C11.1401 15.175 12.4335 14.8285 13.75 14.8285C15.0665 14.8285 16.3599 15.175 17.5 15.8333"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path
                                    d="M2.5 5.00005C3.64014 4.34179 4.93347 3.99524 6.25 3.99524C7.56652 3.99524 8.85986 4.34179 10 5.00005C11.1401 4.34179 12.4335 3.99524 13.75 3.99524C15.0665 3.99524 16.3599 4.34179 17.5 5.00005"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path d="M2.5 5V15.8333" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                  <path d="M10 5V15.8333" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                  <path d="M17.5 5V15.8333" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                                  <clipPath id="clip0_7767_6774">
                                    <rect width="20" height="20" fill="white" />
                                  </clipPath>
                                </defs>
                              </svg>
                          ...
                          <li class="d-flex flex-row gap-2">
                            <span>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_7767_6783)">
                                  <path
                                    d="M5.83329 8.33329H8.33329V5.83329L5.41663 2.91663C6.34965 2.47102 7.39788 2.32563 8.41696 2.50048C9.43604 2.67533 10.3759 3.16181 11.107 3.89294C11.8381 4.62407 12.3246 5.56388 12.4994 6.58296C12.6743 7.60204 12.5289 8.65027 12.0833 9.58329L17.0833 14.5833C17.4148 14.9148 17.6011 15.3645 17.6011 15.8333C17.6011 16.3021 17.4148 16.7518 17.0833 17.0833C16.7518 17.4148 16.3021 17.6011 15.8333 17.6011C15.3645 17.6011 14.9148 17.4148 14.5833 17.0833L9.58329 12.0833C8.65027 12.5289 7.60204 12.6743 6.58296 12.4994C5.56388 12.3246 4.62407 11.8381 3.89294 11.107C3.16181 10.3759 2.67533 9.43604 2.50048 8.41696C2.32563 7.39788 2.47102 6.34965 2.91663 5.41663L5.83329 8.33329Z"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                </g>
                                <defs>
                                  <clipPath id="clip0_7767_6783">
                                    <rect width="20" height="20" fill="white" />
                                  </clipPath>
                                </defs>
                              </svg>
                            </span>
                            <span>Projects to apply learnings</span>
                          </li>
                          <li class="d-flex flex-row gap-2">
                            <span>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_7767_6788)">
                                  <path
                                    d="M9.99998 9.99996C9.54271 10.8876 8.92963 11.6859 8.18998 12.3566C7.72384 12.8229 7.1299 13.1405 6.48327 13.2692C5.83664 13.3979 5.16637 13.3319 4.55722 13.0797C3.94808 12.8274 3.42742 12.4002 3.06111 11.852C2.69479 11.3038 2.49927 10.6593 2.49927 9.99996C2.49927 9.34065 2.69479 8.69614 3.06111 8.14796C3.42742 7.59977 3.94808 7.17253 4.55722 6.92027C5.16637 6.668 5.83664 6.60205 6.48327 6.73075C7.1299 6.85945 7.72384 7.17702 8.18998 7.64329C8.92963 8.31407 9.54271 9.11231 9.99998 9.99996ZM9.99998 9.99996C10.4573 9.11231 11.0703 8.31407 11.81 7.64329C12.2761 7.17702 12.8701 6.85945 13.5167 6.73075C14.1633 6.60205 14.8336 6.668 15.4427 6.92027C16.0519 7.17253 16.5725 7.59977 16.9389 8.14796C17.3052 8.69614 17.5007 9.34065 17.5007 9.99996C17.5007 10.6593 17.3052 11.3038 16.9389 11.852C16.5725 12.4002 16.0519 12.8274 15.4427 13.0797C14.8336 13.3319 14.1633 13.3979 13.5167 13.2692C12.8701 13.1405 12.2761 12.8229 11.81 12.3566C11.0703 11.6859 10.4573 10.8876 9.99998 9.99996Z"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                </g>
                                <defs>
                                  <clipPath id="clip0_7767_6788">
                                    <rect width="20" height="20" fill="white" />
                                  </clipPath>
                                </defs>
                              </svg>
                      ...
                      <div class="col-lg-6">
                        <ul class="list-unstyled mb-0 d-flex flex-column gap-2">
                          <li class="d-flex flex-row gap-2">
                            <span>
                              <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_7767_6793)">
                                  <path
                                    d="M10.5 12.5C10.5 13.163 10.7634 13.7989 11.2322 14.2678C11.7011 14.7366 12.337 15 13 15C13.663 15 14.2989 14.7366 14.7678 14.2678C15.2366 13.7989 15.5 13.163 15.5 12.5C15.5 11.837 15.2366 11.2011 14.7678 10.7322C14.2989 10.2634 13.663 10 13 10C12.337 10 11.7011 10.2634 11.2322 10.7322C10.7634 11.2011 10.5 11.837 10.5 12.5Z"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path d="M11.3335 14.5834V18.3334L13.0002 17.0834L14.6668 18.3334V14.5834" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                  <path
                                    d="M8.83333 15.8333H4.66667C4.22464 15.8333 3.80072 15.6577 3.48816 15.3451C3.17559 15.0326 3 14.6087 3 14.1666V5.83329C3 4.91663 3.75 4.16663 4.66667 4.16663H16.3333C16.7754 4.16663 17.1993 4.34222 17.5118 4.65478C17.8244 4.96734 18 5.39127 18 5.83329V14.1666C17.9997 14.4589 17.9225 14.746 17.7763 14.999C17.63 15.252 17.4198 15.4622 17.1667 15.6083"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path d="M5.5 7.5H15.5" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                  <path d="M5.5 10H8" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                  <path d="M5.5 12.5H7.16667" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                                  <clipPath id="clip0_7767_6793">
                                    <rect width="20" height="20" fill="white" transform="translate(0.5)" />
                                  </clipPath>
                                </defs>
                              </svg>
                            </span>
                            <span>Course certificate upon completion</span>
                          </li>
                          <li class="d-flex flex-row gap-2">
                            <span>
                              <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_7767_6803)">
                                  <path d="M6.33333 6.66663L3 9.99996L6.33333 13.3333" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                  <path d="M14.6665 6.66663L17.9998 9.99996L14.6665 13.3333" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                  <path d="M12.1668 3.33337L8.8335 16.6667" stroke="#754FFE" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                                  <clipPath id="clip0_7767_6803">
                                    <rect width="20" height="20" fill="white" transform="translate(0.5)" />
                                  </clipPath>
                                </defs>
                              </svg>
                          ...
                          <li class="d-flex flex-row gap-2">
                            <span>
                              <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_7767_6810)">
                                  <path
                                    d="M8.8335 10.8333C8.8335 11.2753 9.00909 11.6992 9.32165 12.0118C9.63421 12.3244 10.0581 12.5 10.5002 12.5C10.9422 12.5 11.3661 12.3244 11.6787 12.0118C11.9912 11.6992 12.1668 11.2753 12.1668 10.8333C12.1668 10.3913 11.9912 9.96734 11.6787 9.65478C11.3661 9.34222 10.9422 9.16663 10.5002 9.16663C10.0581 9.16663 9.63421 9.34222 9.32165 9.65478C9.00909 9.96734 8.8335 10.3913 8.8335 10.8333Z"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path
                                    d="M7.1665 17.5V16.6667C7.1665 16.2246 7.3421 15.8007 7.65466 15.4882C7.96722 15.1756 8.39114 15 8.83317 15H12.1665C12.6085 15 13.0325 15.1756 13.345 15.4882C13.6576 15.8007 13.8332 16.2246 13.8332 16.6667V17.5"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path
                                    d="M13 4.16667C13 4.60869 13.1756 5.03262 13.4882 5.34518C13.8007 5.65774 14.2246 5.83333 14.6667 5.83333C15.1087 5.83333 15.5326 5.65774 15.8452 5.34518C16.1577 5.03262 16.3333 4.60869 16.3333 4.16667C16.3333 3.72464 16.1577 3.30072 15.8452 2.98816C15.5326 2.67559 15.1087 2.5 14.6667 2.5C14.2246 2.5 13.8007 2.67559 13.4882 2.98816C13.1756 3.30072 13 3.72464 13 4.16667Z"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path
                                    d="M14.6665 8.33337H16.3332C16.7752 8.33337 17.1991 8.50897 17.5117 8.82153C17.8242 9.13409 17.9998 9.55801 17.9998 10V10.8334"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path
                                    d="M4.6665 4.16667C4.6665 4.60869 4.8421 5.03262 5.15466 5.34518C5.46722 5.65774 5.89114 5.83333 6.33317 5.83333C6.7752 5.83333 7.19912 5.65774 7.51168 5.34518C7.82424 5.03262 7.99984 4.60869 7.99984 4.16667C7.99984 3.72464 7.82424 3.30072 7.51168 2.98816C7.19912 2.67559 6.7752 2.5 6.33317 2.5C5.89114 2.5 5.46722 2.67559 5.15466 2.98816C4.8421 3.30072 4.6665 3.72464 4.6665 4.16667Z"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                  <path
                                    d="M3 10.8334V10C3 9.55801 3.17559 9.13409 3.48816 8.82153C3.80072 8.50897 4.22464 8.33337 4.66667 8.33337H6.33333"
                                    stroke="#754FFE"
                                    stroke-linecap="round"
                                    stroke-linejoin="round" />
                                </g>
                                <defs>
                                  <clipPath id="clip0_7767_6810">
                                    <rect width="20" height="20" fill="white" transform="translate(0.5)" />
                                  </clipPath>
                                </defs>
                              </svg>
                ...
                <div class="d-flex flex-column gap-3">
                  ...
                  <div class="border rounded-3 p-4 d-flex flex-column">
                    <div class="d-flex flex-column gap-3">
                      ...
                      <p class="mb-0">
                        Next, you’ll explore the basics of the language, giving plenty of examples. Lastly, you’ll put your JavaScript knowledge to work and modify a modern, responsive web page. When
                        you’re finished with this course, you’ll have the skills and knowledge in JavaScript to create simple programs, create simple web applications, and modify web pages.
                      </p>
                    </div>
                  ...
                  <div class="border rounded-3 p-4 d-flex flex-column gap-5">
                    <div class="d-flex flex-row align-items-center gap-3">
                      <div class="position-relative">
                        ...
                        <a href="#!" class="position-absolute mt-7 ms-n4" data-bs-toggle="tooltip" data-placement="top" title="Verifed">
                          <img src="../assets/images/course/check.svg" alt="check" height="30" width="30" />
                        </a>
                      </div>
                      <div>
                        <h3 class="mb-0 text-primary">Aenny Wilson</h3>
                          ...
                          <span class="align-baseline lh-1">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <g clip-path="url(#clip0_7767_6882)">
                                <path d="M6.66675 7.5H13.3334" stroke="#475569" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M6.66675 10.8333H10.4167" stroke="#475569" stroke-linecap="round" stroke-linejoin="round" />
                                <path
              ...
              <div id="sidebar">
                <div class="sidebar__inner">
                  <div class="d-flex flex-column gap-4">
                    <div class="card">
                      <a href="#!"><img src="../assets/images/course/figma.jpg" alt="figma" class="img-fluid w-100 card-img-top" /></a>
                      <div class="card-body d-flex flex-column gap-4">
                        <div class="d-flex flex-column gap-1">
                          <div class="d-flex flex-row gap-2 align-items-center">
                            <h3 class="h2 mb-0">$455</h3>
                            <h3 class="mb-0 text-gray-500"><del>$1,455</del></h3>
                          ...
                          <div class="d-flex flex-row gap-2 align-items-center lh-1">
                            ...
                            <span class="text-danger fw-semibold">8 hours left at this price!</span>
                          </div>
                        </div>
                        ...
                        <div class="text-center d-flex flex-column gap-2 text-gray-500">
                          ...
                          <span class="">Full Lifetime Access</span>
                        </div>
                      </div>
                    </div>
                    <div class="card">
                      <div class="card-body">
                        <ul class="list-unstyled mb-0 d-flex flex-column gap-4">
                          ...
                          <li class="d-flex flex-row gap-3 align-items-center">
                            ...
                            <span>Videos, Quizzes and interactive content.</span>
                          </li>
                        </ul>
                      </div>
                    </div>
...
<script src="../assets/js/theme.min.js"></script>
    ...
    <script src="../assets/js/vendors/sticky.js"></script>
