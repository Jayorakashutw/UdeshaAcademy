...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/invoice-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:31 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="invoice-details.html" />
  ...
  <nav class="navbar navbar-expand-lg sidenav sidenav-navbar">
    ...
    <div class="db-content">
      <div class="container mb-4">
        <div class="row mb-5">
          <div class="col-12">
            <h1 class="mb-0 h2">Invoice Details</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            ...
            <div class="card border-0" id="invoice">
              ...
              <div class="card-body">
                <div class="d-flex justify-content-between mb-6">
                  <div>
                    <!-- Img -->
                    <img src="../assets/images/brand/logo/logo-icon.svg" alt="logo" class="mb-4 avatar-lg" />
                    <h4 class="mb-0">Geeks Courses</h4>
                  ...
                  <table class="table mb-0 text-nowrap table-borderless">
                    ...
                    <tbody>
                      <tr class="text-dark">
                        <td>
                          Monthly
                          <span class="fs-6">(1 Jan,2020 to 1 Feb, 2020)</span>
                        </td>
                        <td>1</td>
                        <td>$39.00</td>
                        <td>$39.00</td>
