...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/all-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:31 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="all-courses.html">
    <link rel="stylesheet" href="../assets/libs/tiny-slider/dist/tiny-slider.css" />
    <title>Dashboard Courses| Geeks - Bootstrap 5 Template</title>
  </head>
    ...
    <div class="db-content">
      <div class="container mb-4">
              ...
              <div class="sliderFirst">
                <div class="item">
                  <div class="card border">
                    <a href="#!">
                      <img src="../assets/images/course/course-gatsby.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                    </a>
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">Get to Know Gatsby Building Blocks - GatsbyJS</a></h3>
                      ...
                      <div class="row align-items-center g-0">
                        ...
                        <div class="col-auto">
                          <a href="#" class="text-reset bookmark">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmarks text-gray-500" viewBox="0 0 16 16">
                              <path
                ...
                <div class="item">
                  <div class="card border">
                    <a href="#!">
                      <img src="../assets/images/course/course-graphql.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                    </a>
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">Getting Started Practical Learn With GraphQL.js</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
                ...
                <div class="item">
                  <div class="card border">
                    <a href="#!">
                      <img src="../assets/images/course/course-node.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                    </a>
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">The Complete Node.js Developer Course</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
                ...
                <div class="item">
                  <div class="card border">
                    <a href="#!">
                      <img src="../assets/images/course/course-wordpress.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                    </a>
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">The Complete WordPress Website Course</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
        ...
        <div class="row gy-5 mb-6">
          <div class="col-lg-7 col-12">
            <div class="d-flex flex-column gap-2">
              ...
              <p class="mb-0">Learn to code through our courses and paths and become a backend engineer in Python or Java, or learn to code for databases, machine learning or data science.</p>
            </div>
          </div>
            ...
            <div class="position-relative">
              ...
              <div class="sliderSecond">
                <div class="item">
                  <div class="card border">
                    <a href="#!">
                      <img src="../assets/images/course/course-angular.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                    </a>
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">Angular - the complete guide for beginner</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
                ...
                <div class="item">
                  <div class="card border">
                    <a href="#!">
                      <img src="../assets/images/course/course-python.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                    </a>
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">The Python Course: build web application</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
                ...
                <div class="item">
                  <div class="card border">
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">GraphQL: introduction to graphQL for beginners</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
                ...
                <div class="item">
                  <div class="card border">
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">How to easily create a website with React</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
        ...
        <div class="row gy-5">
          <div class="col-lg-7 col-12">
            <div class="d-flex flex-column gap-2">
              <h2 class="h3 mb-0">Learn JavaScript</h2>
              <p class="mb-0">
                Master JavaScript with comprehensive courses on core programming fundamentals, web application security, and modern ES6+ features, empowering you to build interactive, secure, and
                efficient applications.
              </p>
            </div>
          </div>
          <div class="col-lg-5 col-12 text-end">
            <a href="#!" class="btn btn-white">Explore Learn JavaScript</a>
          </div>
            ...
            <div class="position-relative">
              ...
              <div class="sliderThird">
                <div class="item">
                  <div class="card border">
                    <a href="#!">
                      <img src="../assets/images/course/course-javascript.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                    </a>
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">Creating a Custom Event in Javascript</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
                ...
                <div class="item">
                  <div class="card border">
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">Morden JavaScript Beginner Tutorial - Simple</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
                ...
                <div class="item">
                  <div class="card border">
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">Applying JavaScript and using the console.</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
                          ...
                          <span class="text-gray-500">1h 30m</span>
                        </li>
                        <li class="list-inline-item">
                          <svg class="me-1 mt-n1" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="3" y="8" width="2" height="6" rx="1" fill="#754FFE"></rect>
                ...
                <div class="item">
                  <div class="card border">
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                      <h3 class="h4 mb-0"><a href="#!" class="text-inherit">Creating functions, using them, passing data in and out.</a></h3>
                      <ul class="mb-0 list-inline">
                        <li class="list-inline-item lh-1">
                          <span class="align-bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock text-gray-400" viewBox="0 0 16 16">
