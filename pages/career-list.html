...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/career-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:13 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="career-list.html" />
    <title>Career List | Geeks - Academy Admin Template</title>
  </head>
  ...
  <div class="container-fluid px-0">
    ...
    <main>
        ...
        <div class="container my-lg-8">
          <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6 col-12">
              <div class="mb-5">
                <h1 class="display-3 mb-4 fw-bold">Join the team, we’re growing fast!</h1>
                <p class="lead mb-4 pe-xl-8">We’re looking for incredible people to build on our strong momentum. Help us power the brands you know and love.</p>
                <a href="#position" class="btn btn-primary">See All Open Positions</a>
                <p class="mt-4 mb-0">
                  69 open positions across and
                  <a href="#">all offices</a>
                  and
                  <a href="#">all teams</a>
                  .
                </p>
      ...
      <!-- position -->
      <section class="py-8 bg-white" id="position">
        <div class="container">
          <div class="row">
            <div class="col-xl-8 col-lg-10 col-md-12 col-12">
              <!-- heading -->
              <h1 class="display-4 mt-2 mb-3 fw-bold">All open positions</h1>
              <!-- para -->
              <p class="fs-3 pe-lg-8 me-lg-8">
              ...
              <div class="row mt-8">
                ...
                <div class="col-lg-6 col-md-6 col-12 mt-3 mt-lg-0">
                  <label class="form-label visually-hidden" for="careerListOffices">Offices</label>
                  <select class="form-select" data-choices="" id="careerListOffices" name="careerListOffices">
                ...
                <!-- select menu -->
                <div class="col-lg-6 col-md-6 col-12 mt-3 mt-lg-0">
                  <label class="form-label visually-hidden" for="careerListTeam">Team</label>
                  <select class="form-select" data-choices="" id="careerListTeam" name="careerListTeam">
          ...
          <div class="row mt-8">
            <div class="col-12">
              <div class="mb-5">
                ...
                <p class="mb-0">Put your creative ideas into action at a product-driven and design-led organization.</p>
              </div>
              <!-- table -->
              <div class="table-responsive">
                <table class="table table-hover table-lg fs-4 text-nowrap">
                  <tbody>
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Marketing Designer</a></td>
                      <td>
                        San Francisco
                        <span>(Remote)</span>
                      </td>
                      <td class="text-end">
                        <a href="career-single.html"><i class="fe fe-chevron-right"></i></a>
                      </td>
                    </tr>
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Product Design Lead</a></td>
                    ...
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Brand Designer</a></td>
                      <td>
                        Canada
                        <span>(Remote)</span>
                      </td>
                    ...
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Sr. UX Engineer</a></td>
                      <td>
                        Ireland
                        <span>(Remote)</span>
                      </td>
          ...
          <div class="row mt-8">
            <div class="col-12">
              <!-- heading -->
              <div class="mb-5">
                <h2 class="fw-bold">Engineering</h2>
                <p class="mb-0">Develop quality code that is built for scale for millions of people looking to eliminate “work about work” with our platform.</p>
              </div>
              <!-- table -->
              <div class="table-responsive">
                <table class="table table-hover table-lg fs-4 text-nowrap">
                  <tbody>
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Principal Data Engineer</a></td>
                      <td>
                        Philippines
                        <span>(Remote)</span>
                      </td>
                    ...
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Software Engineer Ruby on Rails</a></td>
                      <td>United Kingdom</td>
                      <td class="text-end">
                        <a href="career-single.html"><i class="fe fe-chevron-right"></i></a>
                      </td>
                    ...
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Sr. Engineering Manager</a></td>
                      <td>
                        Canada
                        <span>(Remote)</span>
                      </td>
                    ...
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Sr. React Engineer</a></td>
                      <td>
                        United Kingdom
                        <span>(Remote)</span>
                      </td>
          ...
          <div class="row mt-8">
            <div class="col-12">
              <div class="mb-5">
                <h2 class="fw-bold">General & Administrative</h2>
                <p class="mb-0">Recruit, retain, and enable our growing number of Geeks through programs that support our people and our business.</p>
              </div>
              <!-- table -->
              <div class="table-responsive">
                <table class="table table-hover table-lg fs-4 text-nowrap">
                  <tbody>
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Account Executive</a></td>
                      <td>
                        Philippines
                        <span>(Remote)</span>
                      </td>
                    ...
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Customer Success Manager</a></td>
                      <td>
                        United Kingdom
                        <span>(Remote)</span>
                      </td>
                    ...
                    <tr>
                      <td><a href="career-single.html" class="text-inherit">Sales Development Representative</a></td>
                      <td>
                        Canada
                        <span>(Remote)</span>
                      </td>
