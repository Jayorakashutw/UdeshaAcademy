...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/learning-path.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:31 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="learning-path.html" />

    <title>Dashboard Learning Path| Geeks - Bootstrap 5 Template</title>
  </head>
    ...
    <div class="db-content">
      <div class="container mb-4">
              ...
              <div class="card-body d-flex flex-column gap-4">
                <div>
                  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="f8b00698">
                      <circle id="0dd51b41" cx="24" cy="24" r="24" fill="#754FFE"></circle>
                      <g id="b6a97513">
                        <path
                          id="92142989"
                          d="M20.7809 19.281C20.8506 19.2112 20.9059 19.1285 20.9437 19.0373C20.9814 18.9462 21.0008 18.8486 21.0008 18.75C21.0008 18.6514 20.9814 18.5537 20.9437 18.4626C20.9059 18.3715 20.8506 18.2887 20.7809 18.219C20.7111 18.1492 20.6284 18.0939 20.5373 18.0562C20.4461 18.0184 20.3485 17.999 20.2499 17.999C20.1513 17.999 20.0536 18.0184 19.9625 18.0562C19.8714 18.0939 19.7886 18.1492 19.7189 18.219L14.4689 23.469C14.399 23.5386 14.3436 23.6214 14.3058 23.7125C14.268 23.8036 14.2485 23.9013 14.2485 24C14.2485 24.0986 14.268 24.1963 14.3058 24.2874C14.3436 24.3785 14.399 24.4613 14.4689 24.531L19.7189 29.781C19.8597 29.9218 20.0507 30.0009 20.2499 30.0009C20.449 30.0009 20.64 29.9218 20.7809 29.781C20.9217 29.6401 21.0008 29.4491 21.0008 29.25C21.0008 29.0508 20.9217 28.8598 20.7809 28.719L16.0604 24L20.7809 19.281ZM27.2189 19.281C27.078 19.1401 26.9989 18.9491 26.9989 18.75C26.9989 18.5508 27.078 18.3598 27.2189 18.219C27.3597 18.0781 27.5507 17.999 27.7499 17.999C27.949 17.999 28.14 18.0781 28.2809 18.219L33.5309 23.469C33.6007 23.5386 33.6561 23.6214 33.6939 23.7125C33.7318 23.8036 33.7512 23.9013 33.7512 24C33.7512 24.0986 33.7318 24.1963 33.6939 24.2874C33.6561 24.3785 33.6007 24.4613 33.5309 24.531L28.2809 29.781C28.14 29.9218 27.949 30.0009 27.7499 30.0009C27.5507 30.0009 27.3597 29.9218 27.2189 29.781C27.078 29.6401 26.9989 29.4491 26.9989 29.25C26.9989 29.0508 27.078 28.8598 27.2189 28.719L31.9394 24L27.2189 19.281Z"
                          fill="white"></path>
                      </g>
                    </g>
                  </svg>
                ...
                <div class="d-flex flex-column gap-2">
                  <h2 class="mb-0 h3">
                    <a href="learning-path-single.html" class="text-inherit">Front End Developer</a>
                  </h2>
                  <p class="mb-0">Become proficient in designing and building responsive and interactive websites.</p>
                </div>
                <div class="d-flex flex-row align-items-center justify-content-between">
            ...
            <div class="card card-lift">
              <div class="card-body d-flex flex-column gap-4">
                <div>
                  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="5fa93974">
                      <circle id="ba50607b" cx="24" cy="24" r="24" fill="#E53E3E"></circle>
                      <g id="8b6d18c2">
                        <path
                          id="db63b677"
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M13.671 24.0945V23.85C15.1785 23.697 15.9165 22.9275 15.9165 21.45V18.7545C15.9165 17.1135 16.5015 16.4475 17.9475 16.4475H18.357V15H17.793C15.375 15 14.235 16.1385 14.235 18.528V20.814C14.235 22.455 13.671 22.998 12 22.998V24.9465C13.671 24.9465 14.235 25.4895 14.235 27.1305V29.4165C14.235 31.806 15.3735 32.9445 17.793 32.9445H18.357V31.4985H17.9475C16.5015 31.4985 15.9165 30.8325 15.9165 29.1915V26.4945C15.9165 25.0185 15.1785 24.249 13.671 24.0945ZM34.329 23.85V24.096C32.8215 24.2505 32.0835 25.02 32.0835 26.496V29.193C32.0835 30.834 31.4985 31.5 30.0525 31.5H29.643V32.946H30.207C32.6265 32.946 33.765 31.8075 33.765 29.418V27.132C33.765 25.491 34.329 24.948 36 24.948V22.998C34.329 22.998 33.765 22.455 33.765 20.814V18.528C33.765 16.1385 32.625 15 30.207 15H29.643V16.446H30.0525C31.4985 16.446 32.0835 17.112 32.0835 18.753V21.45C32.0835 22.926 32.8215 23.6955 34.329 23.85ZM23.25 29.25V25.8105L20.8185 28.242L19.758 27.1815L22.188 24.75H18.75V23.25H22.1895L19.758 20.8185L20.8185 19.758L23.25 22.188V18.75H24.75V22.1895L27.1815 19.758L28.242 20.8185L25.812 23.25H29.25V24.75H25.8105L28.242 27.1815L27.1815 28.242L24.75 25.812V29.25H23.25Z"
                          fill="white"></path>
                      </g>
                    </g>
                  </svg>
                ...
                <div class="d-flex flex-column gap-2">
                  <h2 class="mb-0 h3">
                    <a href="#!" class="text-inherit">Back End Developer</a>
                  </h2>
                  <p class="mb-0">Master server-side development to build efficient, scalable, and secure applications.</p>
                </div>
                <div class="d-flex flex-row align-items-center justify-content-between">
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
                    ...
                    <span class="fw-medium text-gray-500">6-8 months</span>
                  </div>
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-check text-gray-400" viewBox="0 0 16 16">
                    ...
                    <span class="fw-medium text-gray-500">9 Modules</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card card-lift">
              <div class="card-body d-flex flex-column gap-4">
                <div>
                  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="2325dd1d">
                      <circle id="63aae84f" cx="24" cy="24" r="24" fill="#0EA5E9"></circle>
                      <g id="c22d2368">
                        <path
                          id="ac1caac2"
                          d="M20.5199 20.688L23.0174 23.625L20.5214 26.562C19.9423 27.1332 19.2072 27.5203 18.4086 27.6749C17.61 27.8294 16.7836 27.7444 16.0331 27.4305C15.2827 27.1166 14.6419 26.5879 14.1912 25.9108C13.7404 25.2337 13.4999 24.4384 13.4999 23.625C13.4999 22.8116 13.7404 22.0163 14.1912 21.3392C14.6419 20.6621 15.2827 20.1334 16.0331 19.8195C16.7836 19.5056 17.61 19.4206 18.4086 19.5751C19.2072 19.7297 19.9423 20.1168 20.5214 20.688H20.5199ZM23.9999 22.467L21.6239 19.6695L21.6029 19.647C20.8162 18.8605 19.8139 18.3249 18.7228 18.108C17.6317 17.8911 16.5008 18.0025 15.473 18.4283C14.4453 18.8541 13.5669 19.5751 12.9489 20.5001C12.3308 21.4251 12.001 22.5125 12.001 23.625C12.001 24.7375 12.3308 25.8249 12.9489 26.7499C13.5669 27.6749 14.4453 28.3959 15.473 28.8217C16.5008 29.2475 17.6317 29.3589 18.7228 29.142C19.8139 28.9251 20.8162 28.3895 21.6029 27.603L21.6239 27.5805L23.9999 24.783L26.3759 27.5805L26.3969 27.603C27.1837 28.3895 28.1859 28.9251 29.277 29.142C30.3681 29.3589 31.4991 29.2475 32.5268 28.8217C33.5546 28.3959 34.433 27.6749 35.051 26.7499C35.669 25.8249 35.9989 24.7375 35.9989 23.625C35.9989 22.5125 35.669 21.4251 35.051 20.5001C34.433 19.5751 33.5546 18.8541 32.5268 18.4283C31.4991 18.0025 30.3681 17.8911 29.277 18.108C28.1859 18.3249 27.1837 18.8605 26.3969 19.647L26.3759 19.6695L23.9999 22.467ZM24.9839 23.625L27.4784 20.688C28.0576 20.1168 28.7927 19.7297 29.5913 19.5751C30.3898 19.4206 31.2163 19.5056 31.9667 19.8195C32.7171 20.1334 33.358 20.6621 33.8087 21.3392C34.2594 22.0163 34.4999 22.8116 34.4999 23.625C34.4999 24.4384 34.2594 25.2337 33.8087 25.9108C33.358 26.5879 32.7171 27.1166 31.9667 27.4305C31.2163 27.7444 30.3898 27.8294 29.5913 27.6749C28.7927 27.5203 28.0576 27.1332 27.4784 26.562L24.9839 23.625Z"
                          fill="white"></path>
                      </g>
                    </g>
                  </svg>
                ...
                <div class="d-flex flex-column gap-2">
                  <h2 class="mb-0 h3">
                    <a href="#!" class="text-inherit">DevOps Engineer</a>
                  </h2>
                  <p class="mb-0">Gain expertise in managing software development lifecycles, automation...</p>
                </div>
                <div class="d-flex flex-row align-items-center justify-content-between">
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
                    ...
                    <span class="fw-medium text-gray-500">6-9 months</span>
                  </div>
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-check text-gray-400" viewBox="0 0 16 16">
                    ...
                    <span class="fw-medium text-gray-500">10 Modules</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row g-4">
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card card-lift">
              <img src="../assets/images/path/path-full-stack.png" alt="path full stack" class="card-img-top img-fluid" />
              <div class="card-body d-flex flex-column gap-4">
                <div class="d-flex flex-column gap-2">
                  <h2 class="mb-0 h3">
                    <a href="#!" class="text-inherit">Full Stack Developer</a>
                  </h2>
                  <p class="mb-0">Master both front-end and back-end technologies to build complete, scalable, and functional web applications.</p>
                </div>
                <div class="d-flex flex-row align-items-center justify-content-between">
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
                    ...
                    <span class="fw-medium text-gray-500">6-12 months</span>
                  </div>
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-check text-gray-400" viewBox="0 0 16 16">
          ...
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card card-lift">
              <img src="../assets/images/path/path-api.png" alt="path full stack" class="card-img-top img-fluid" />
              <div class="card-body d-flex flex-column gap-4">
                <div class="d-flex flex-column gap-2">
                  <h2 class="mb-0 h3">
                    <a href="#!" class="text-inherit">API Design</a>
                  </h2>
                  <p class="mb-0">Master the principles, tools, and practices required to design, develop, and secure efficient APIs.</p>
                </div>
                <div class="d-flex flex-row align-items-center justify-content-between">
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
                    ...
                    <span class="fw-medium text-gray-500">4-6 months</span>
                  </div>
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-check text-gray-400" viewBox="0 0 16 16">
                    ...
                    <span class="fw-medium text-gray-500">5 Modules</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card card-lift">
              <img src="../assets/images/path/path-ux.png" alt="path full stack" class="card-img-top img-fluid" />
              <div class="card-body d-flex flex-column gap-4">
                <div class="d-flex flex-column gap-2">
                  <h2 class="mb-0 h3">
                    <a href="#!" class="text-inherit">UX Design</a>
                  </h2>
                  <p class="mb-0">Master the principles, tools, and practices required to design intuitive, user-centered digital experiences.</p>
                </div>
                <div class="d-flex flex-row align-items-center justify-content-between">
                  <div class="d-flex align-items-center gap-2 lh-1">
                    <span>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/learning-path.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:33 GMT -->
</html>
