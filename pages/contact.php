...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:25 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <title>Contact | Geeks - Academy Admin Template</title>
  </head>
							...
							<div>
								...
								<form class="row needs-validation" novalidate>
									...
									<div class="mb-3 col-12">
										...
										<select class="form-select" data-choices="" id="contactReason" required>
											<option value="">Select</option>
											<option value="Design">Design</option>
											<option value="Development">Development</option>
											<option value="Other">Other</option>
										  </select>
										<div class="invalid-feedback">Please choose contact reason</div>
									</div>
									<!-- form group -->
									<div class="mb-3 col-12">
