...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/course-filter-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:47:55 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="course-filter-grid.html" />

    <title>Grid View V2 | Geeks - Bootstrap 5 Template</title>
  </head>
              ...
              <div class="d-flex flex-column gap-5">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Courses Grid</li>
                  </ol>
                </nav>
                <div class="d-flex flex-column">
                  <h1 class="mb-0">Courses Grid</h1>
              ...
              <div class="d-flex flex-column gap-3">
                ...
                <div class="row gy-4">
                  ...
                  <div class="col-xl-4 col-md-6 col-12">
                    <div class="card card-lift">
                      <a href="#!">
                        <img src="../assets/images/course/mongodb.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                      </a>
                      <div class="card-body d-flex flex-column gap-4">
                        <div class="d-flex flex-column gap-2">
                          <div>
                  ...
                  <div class="col-xl-4 col-md-6 col-12">
                    <div class="card card-lift">
                      <a href="#!">
                        <img src="../assets/images/course/supabase.jpg" alt="figma" class="card-img-top img-fluid w-100" />
                      </a>
                      <div class="card-body d-flex flex-column gap-4">
                        <div class="d-flex flex-column gap-2">
                          <div>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/course-filter-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:47:56 GMT -->
</html>
