...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/my-quiz.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:33 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="my-quiz.html" />

    <title>Dashboard My Quiz| Geeks - Bootstrap 5 Template</title>
  </head>
  ...
  <nav class="navbar navbar-expand-lg sidenav sidenav-navbar">
    ...
    <div class="db-content">
      <div class="container mb-4">
        ...
        <div class="row mb-6 gy-4">
          <div class="col-xl-4 col-lg-6">
            <div class="d-flex flex-column gap-3">
              <h2 class="mb-0 h3">Progress Summary</h2>
              <div class="card h-100">
                <div class="card-body">
                  <div class="d-flex flex-column gap-1 border-bottom pb-4">
                    <h3 class="mb-0 h1">4</h3>
                    <span class="fw-medium">Total Quizzes Taken</span>
                  </div>
                  <div class="d-flex flex-column gap-1 border-bottom py-4">
                    <h3 class="mb-0 h1">1</h3>
                    <span class="fw-medium">Quizzes Completed</span>
                  </div>
                  <div class="d-flex flex-column gap-1 pt-4">
                    <h3 class="mb-0 h1 text-success">85%</h3>
          ...
          <div class="col-xl-8 col-lg-6 col-12">
            <div class="d-flex flex-column gap-3">
              <h2 class="mb-0 h3">Ongoing Quiz</h2>
              <div class="card h-100">
                <div class="card-body d-flex flex-column gap-5">
                  <div class="d-flex flex-row justify-content-between">
                    <div class="d-flex flex-column gap-md-1 gap-2">
                      ...
                      <div class="d-flex flex-xl-row flex-column align-items-xl-center gap-1 lh-1">
                        <span>Course</span>
                        <a href="#!">
                  ...
                  <div class="d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="d-flex flex-row">
                      <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle" data-bs-toggle="tooltip" data-placement="top" title="info">
        ...
        <div class="row gy-4 mb-7">
          <div class="col-12">
            <h2 class="mb-0 h3">Completed Quizzes:</h2>
          </div>
          <div class="col-xl-4 col-lg-6 col-12">
            <div class="card border-success">
              <div class="card-body d-flex flex-column gap-4">
                <span class="text-success fw-semibold">Score: 85%</span>
                <div class="d-flex flex-row justify-content-between">
                  <div class="d-flex flex-column gap-1">
                    <h3 class="mb-0">
                      <a href="#!" class="text-inherit">HTML Basics Quiz</a>
                    </h3>
                    <div class="d-flex flex-row align-items-center gap-1 lh-1">
                      <span>Course</span>
                      <a href="#!">
                        Web Development
                        <span class="align-text-top">
                ...
                <div class="d-flex flex-row align-items-center justify-content-between">
                  <a href="quiz-result.html" class="btn btn-success">View Result</a>
                  <div class="d-flex flex-row">
                    <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle" data-bs-toggle="tooltip" data-placement="top" title="info">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="78b9f696" clip-path="url(#e16d3067)">
          ...
          <div class="col-xl-4 col-lg-6 col-12">
            <div class="card border-danger">
              <div class="card-body d-flex flex-column gap-4">
                <span class="text-danger fw-semibold">Score: 12%</span>
                <div class="d-flex flex-row justify-content-between">
                  <div class="d-flex flex-column gap-1">
                    <h3 class="mb-0">
                ...
                <div class="d-flex flex-row align-items-center justify-content-between">
                  <a href="quiz-result.html" class="btn btn-danger">View Result</a>
                  <div class="d-flex flex-row">
                    <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle" data-bs-toggle="tooltip" data-placement="top" title="info">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="78b9f696" clip-path="url(#e16d3067)">
        ...
        <div class="row gy-4">
          <div class="col-12">
            <h4 class="mb-0 h3">Upcoming Quizzes</h4>
          </div>
