...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/course-resume.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:47:59 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="course-resume.html" />
    ...
    <main>
                ...
                <div class="tab-pane fade show active" id="course-intro" role="tabpanel" aria-labelledby="course-intro-tab">
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div>
                      <!-- Dropdown -->
                      <span class="dropdown">
                        <a href="#" class="ms-2" id="dropdownInfo" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <!-- Dropdown -->
                      <span class="dropdown">
                        <a class=" " href="#" role="button" id="shareDropdown2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="tab-pane fade" id="course-development" role="tabpanel" aria-labelledby="course-development-tab">
                  <div class="d-lg-flex align-items-center justify-content-between mb-4">
                    ...
                    <div>
                      <!-- Dropdown -->
                      <span class="dropdown">
                        <a href="#" class="ms-2" id="dropdownInfo2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="fe fe-help-circle"></i>
                        </a>
                ...
                <div class="tab-pane fade" id="course-project" role="tabpanel" aria-labelledby="course-project-tab">
                  <div class="d-lg-flex align-items-center justify-content-between mb-4">
                    ...
                    <div>
                      <!-- Dropdown -->
                      <span class="dropdown">
                        <a href="#" class="ms-2" id="dropdownInfo3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="fe fe-help-circle"></i>
                        </a>
                      ...
                      <!-- Dropdown -->
                      <span class="dropdown">
                        <a class=" " href="#" role="button" id="shareDropdown3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="fe fe-more-vertical"></i>
                        </a>
                ...
                <div class="tab-pane fade" id="course-website" role="tabpanel" aria-labelledby="course-website-tab">
                  <div class="d-lg-flex align-items-center justify-content-between mb-4">
                    ...
                    <div>
                      <!-- Dropdown -->
                      <span class="dropdown">
                        <a href="#" class="ms-2" id="dropdownInfo4" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="fe fe-help-circle"></i>
                        </a>
                      ...
                      <!-- Dropdown -->
                      <span class="dropdown">
                        <a class=" " href="#" role="button" id="shareDropdown4" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="fe fe-more-vertical"></i>
                        </a>
      ...
      <section class="card course-sidebar" id="courseAccordion">
        ...
        <ul class="list-group list-group-flush" style="height: 850px" data-simplebar>
          ...
          <li class="list-group-item">
            <!-- Toggle -->
            <a class="d-flex align-items-center h4 mb-0" data-bs-toggle="collapse" href="#courseFour" role="button" aria-expanded="false" aria-controls="courseFour">
              <div class="me-auto">
                <!-- Title -->
          ...
          <li class="list-group-item">
            <!-- Toggle -->
            <a class="d-flex align-items-center h4 mb-0" data-bs-toggle="collapse" href="#courseSix" role="button" aria-expanded="false" aria-controls="courseSix">
              <div class="me-auto">
                <!-- Title -->
                Program Flow
              </div>
          ...
          <li class="list-group-item">
            <!-- Toggle -->
            <a class="d-flex align-items-center h4 mb-0" data-bs-toggle="collapse" href="#courseSeven" role="button" aria-expanded="false" aria-controls="courseSeven">
              <div class="me-auto">
                <!-- Title -->
                Functions
              </div>
          ...
          <li class="list-group-item">
            <!-- Toggle -->
            <a class="d-flex align-items-center h4 mb-0 justify-content-between" data-bs-toggle="collapse" href="#courseEight" role="button" aria-expanded="false" aria-controls="courseEight">
              <div class="me-auto">
                <!-- Title -->
                Objects and the DOM
              </div>
          ...
          <li class="list-group-item">
            <!-- Toggle -->
            <a class="d-flex align-items-center h4 mb-0" data-bs-toggle="collapse" href="#courseNine" role="button" aria-expanded="false" aria-controls="courseNine">
              <div class="me-auto">
                <!-- Title -->
                Arrays
              </div>
          ...
          <li class="list-group-item">
            <!-- Toggle -->
            <a class="d-flex align-items-center h4 mb-0" data-bs-toggle="collapse" href="#courseTen" role="button" aria-expanded="false" aria-controls="courseTen">
              <div class="me-auto">
                <!-- Title -->
                Scope and Hoisting
              </div>
          ...
          <li class="list-group-item">
            ...
            <div class="collapse" id="courseEleven" data-bs-parent="#courseAccordion">
              <div class="py-4">
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae esse velit eos sunt ab inventore est tenetur blanditiis? Voluptas eius molestiae ad itaque tempora nobis minima
                  eveniet aperiam molestias.
                </p>
