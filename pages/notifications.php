...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:49 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <title>Dashboard Setting| Geeks - Bootstrap 5 Template</title>
  </head>
            ...
            <div class="card">
              ...
              <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <p class="mb-0">You will get only notification what have enabled.</p>
                </div>
                <div>
              ...
              <div class="card-body">
                ...
                <div>
                  ...
                  <ul class="list-group list-group-flush mb-4">
                    ...
                    <li class="list-group-item d-flex justify-content-between px-0">
                      <div>
                        ...
                        <span class="text-body">Public Discussions outside of a class that teachers share to all of their followers.</span>
                      </div>
                      <div>
                        <div class="form-check form-switch">
                    ...
                    <li class="list-group-item d-flex justify-content-between px-0">
                      <div>
                        ...
                        <span class="text-body">Weekly recommendations tailored to your interests.</span>
                      </div>
                      <div>
                        <div class="form-check form-switch">
                    ...
                    <li class="list-group-item d-flex justify-content-between px-0">
                      <div>
                        ...
                        <p class="mb-0 text-body">Tips on Courses and dashboard usage, workshop, books, tutorials and many insightful articles.</p>
                      </div>
                      <div>
                        <div class="form-check form-switch">
                    ...
                    <li class="list-group-item d-flex justify-content-between px-0">
                      <div>
                        ...
                        <p class="mb-0 text-body">We'll send you a newsletter announcing essential product updates in CoursesUI.</p>
                      </div>
                      <div>
                        <div class="form-check form-switch">
                    ...
                    <li class="list-group-item d-flex justify-content-between px-0">
                      <div>
                        ...
                        <p class="mb-0 text-body">Announcing promos and upcoming events,such as Ask Me Anything sessions and webinars.</p>
                      </div>
                      <div>
                        <div class="form-check form-switch">
                  ...
                  <p class="mb-0">Please note: you'll still receive important administrative emails,such as password resets.</p>
                </div>
              </div>
            </div>
          </div>
