...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/payment-method.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:29 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="payment-method.html" />
  ...
  <nav class="navbar navbar-expand-lg sidenav sidenav-navbar">
    ...
    <div class="db-content">
      <div class="container mb-4">
        <div class="row mb-5">
          <div class="col-12">
            <h1 class="h2 mb-0">Payment Method</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            ...
            <div>
              ...
              <form class="row mb-4 needs-validation" novalidate>
                ...
                <div class="mb-3 col-12 col-md-4">
                  ...
                  <select class="form-select" data-choices="" id="month" required>
                ...
                <div class="mb-3 col-12 col-md-4">
                  ...
                  <select class="form-select" data-choices="" id="year" required>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/payment-method.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:30 GMT -->
</html>
