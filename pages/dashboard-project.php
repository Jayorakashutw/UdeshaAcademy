...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:04 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="dashboard-project.html" />

    <title>Dashboard Projects| Geeks - Bootstrap 5 Template</title>
  </head>
        ...
        <div class="row gy-4">
              ...
              <div class="col-lg-5 col-md-6">
                <div class="row g-3">
                  <div class="col-6">
                    ...
                    <select class="form-select" data-choices="" id="projectTopics" name="projectTopics">
                  ...
                  <div class="col-6">
                    ...
                    <select class="form-select" data-choices="" id="projectIndustries" name="projectIndustries">
                      <option value="">Industries</option>
                      <option value="industries1">industries1</option>
                      <option value="industries2">industries2</option>
                      <option value="industries3">industries3</option>
                    </select>
                  </div>
                </div>
              </div>
          ...
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card h-100">
              <div class="card-body d-flex flex-column gap-3">
                <div>
                  <span class="badge bg-warning-subtle rounded-pill text-warning">Beginner</span>
                </div>
                ...
                <div>
                  <a href="project-single.html" class="btn btn-success">Continue</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card h-100">
              <div class="card-body d-flex flex-column gap-3">
                ...
                <h3 class="mb-0">Personal Expense Tracker</h3>
                <p class="mb-0">Create an application where users can log income and expenses and visualize data using charts. Introduction to CRUD operations. Data visualization and analytics.</p>
                <div class="d-flex flex-row gap-2">
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">Python</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">Node-js</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">React</span>
                </div>
                ...
                <div>
                  <a href="project-single.html" class="btn btn-outline-dark">Start</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card h-100">
              <div class="card-body d-flex flex-column gap-3">
                <div>
                  <span class="badge bg-info-subtle rounded-pill text-info">Intermediate</span>
                </div>
                <h3 class="mb-0">Weather App</h3>
                <p class="mb-0">Develop a weather app that fetches real-time weather data using an external API. Understanding API calls and response handling.</p>
                <div class="d-flex flex-row gap-2">
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">Node-js</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">React</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">MongoDB</span>
                </div>
          ...
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card h-100">
              <div class="card-body d-flex flex-column gap-3">
                ...
                <h3 class="mb-0">Quiz App</h3>
                <p class="mb-0">Design a quiz application where users can take quizzes, get scores, and view analytics. User experience design for interactive elements.</p>
                <div class="d-flex flex-row gap-2">
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">CSS</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">HTML</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">Javascript</span>
          ...
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card h-100">
              <div class="card-body d-flex flex-column gap-3">
                ...
                <h3 class="mb-0">Portfolio Website</h3>
                <p class="mb-0">Create a personal portfolio website to showcase projects and skills. Focus on design and aesthetics. Emphasize responsive design and accessibility.</p>
                <div class="d-flex flex-row gap-2">
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">CSS</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">HTML</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">Javascript</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">Next.js</span>
                </div>
          ...
          <div class="col-xl-4 col-md-6 col-12">
            <div class="card h-100">
              <div class="card-body d-flex flex-column gap-3">
                <div>
                  <span class="badge bg-danger-subtle rounded-pill text-danger">Advanced</span>
                </div>
                <h3 class="mb-0">Library Management System</h3>
                <p class="mb-0">Develop a system for managing library books, members, and transactions. Full-stack project experience. Emphasis on database design and relationships.</p>
                <div class="d-flex flex-row gap-2 flex-wrap">
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">Django</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">JavaScript</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">PostgreSQL</span>
                  <span class="badge bg-light-subtle border rounded-pill text-secondary">Bootstrap</span>
                </div>
