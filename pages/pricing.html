...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:23 GMT -->
<head>
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <title>Pricing | Geeks - Bootstrap 5 Template</title>
  </head>
          ...
          <div class="row align-items-center">
            <div class="offset-xl-2 col-xl-8">
              <div class="text-center mb-6 px-md-8">
                <h1 class="text-white display-3 fw-bold">Simple pricing that scales with your business</h1>
                <p class="text-white lead mb-4">Reference giving information on its origins, as well as a random Lipsum generator.</p>
                <!-- Switch Toggle -->
          ...
          <div class="row">
            <div class="col-lg-4">
              ...
              <div class="card border-0 mb-3">
                ...
                <div class="p-5 text-center">
                  <img src="../assets/images/svg/price-icon-1.svg" alt="icon" class="mb-5" />
                  <div class="mb-5">
                  ...
                  <div class="d-flex justify-content-center mb-4">
                    ...
                    <div class="toggle-price-content odometer h1" data-price-monthly="0" data-price-yearly="0">0</div>
                    <span class="align-self-end mb-1 ms-2 toggle-price-content" data-price-monthly="/Monthly" data-price-yearly="/Yearly">/Yearly</span>
                  </div>
                  <div class="d-grid">
            ...
            <div class="col-lg-4">
              ...
              <div class="card border-0 mb-3 mb-lg-0">
                <!-- Card body -->
                <div class="p-5 text-center">
                  <img src="../assets/images/svg/price-icon-2.svg" alt="icon" class="mb-5" />
                  <div class="mb-5">
                    <h2 class="fw-bold">Individual</h2>
                    <p class="mb-0">
                      Access all
                  ...
                  <div class="d-flex justify-content-center mb-4">
                    <span class="h3 mb-0 fw-bold">$</span>
                    <div class="toggle-price-content odometer h1" data-price-monthly="39" data-price-yearly="99">99</div>
                    <span class="align-self-end mb-1 ms-2 toggle-price-content" data-price-monthly="/Monthly" data-price-yearly="/Yearly">/Yearly</span>
                  </div>
                  <div class="d-grid">
                    <a href="#" class="btn btn-primary">Get Month Access</a>
                  </div>
                </div>
                <hr class="m-0" />
                <div class="p-5">
            ...
            <div class="col-lg-4">
              ...
              <div class="card border-0 mb-3 mb-lg-0">
                <!-- Card body -->
                <div class="p-5 text-center">
                  <img src="../assets/images/svg/price-icon-3.svg" alt="icon" class="mb-5" />
                  <div class="mb-5">
                  ...
                  <div class="d-flex justify-content-center mb-4">
                    <span class="h3 mb-0 fw-bold">$</span>
                    <div class="toggle-price-content odometer h1" data-price-monthly="99" data-price-yearly="199">199</div>
                    <span class="align-self-end mb-1 ms-2 toggle-price-content" data-price-monthly="/Monthly" data-price-yearly="/Yearly">/Yearly</span>
                  </div>
                  <div class="d-grid">
                    <a href="#" class="btn btn-outline-primary">Get Team Monthly Access</a>
                  </div>
                </div>
                <hr class="m-0" />
                <div class="p-5">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-2 col-6 mb-4 mb-lg-0">
              <img src="../assets/images/brand/paypal.svg" alt="brandlogo" />
            </div>
            <!-- Client logo -->
            <div class="col-md-4 col-lg-2 col-6 mb-4 mb-lg-0">
              <img src="../assets/images/brand/netflix.svg" alt="brandlogo" />
            </div>
            <!-- Client logo -->
            <div class="col-md-4 col-lg-2 col-6 mb-4 mb-lg-0">
              <img src="../assets/images/brand/xbox.svg" alt="brandlogo" />
            </div>
            <!-- Client logo -->
            <div class="col-md-4 col-lg-2 col-6 mb-4 mb-lg-0">
              <img src="../assets/images/brand/instagram.svg" alt="brandlogo" />
            </div>
            <!-- Client logo -->
            <div class="col-md-4 col-lg-2 col-6 mb-4 mb-lg-0">
              <img src="../assets/images/brand/pinterest.svg" alt="brandlogo" />
            </div>
            <!-- Client logo -->
            <div class="col-md-4 col-lg-2 col-6 mb-4 mb-lg-0">
              <img src="../assets/images/brand/stripe.svg" alt="brandlogo" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4 mb-3">
              ...
              <p>Vestibulum pulvinar est at erat laoreet fringilla. Nullam imperdiet, augue non vestibulum triuam quam, at maximus ex mauris a felis.</p>
            </div>
            <!-- Col -->
            <div class="col-md-6 col-lg-4 mb-3">
              <h4>How does a Course subscription work?</h4>
              <p>Donec tempus imperdiet libero quis ultricies. Donec nunc nisi, imperdiet nec porta ultrices, accumsan a nibh.</p>
            </div>
            <!-- Col -->
            <div class="col-md-6 col-lg-4 mb-3">
              <h4>Can I cancel anytime?</h4>
              <p>Yes, Pellentesque habitant morbi tristique senectus et netus fficitur eget lacus eu, gravida blandit sem. Duis aliquam convallis tempor.</p>
            </div>
            <!-- Col -->
            <div class="col-md-6 col-lg-4 mb-3">
              <h4>How long is my personal free trial?</h4>
              <p>Aliquam vel sodales est. Mauris eu dignissim dolor. Praesent scelerisque dolor risus, quis viverra interdum turpis tincidunt interdum.</p>
            </div>
            <!-- Col -->
            <div class="col-md-6 col-lg-4 mb-3">
              <h4>What are Course team plan?</h4>
              <p>Quisque accumsan odio sed congue u eleifend est porttitor nisi lobortis, sit aget dolor rhoncus tincidunt vel a mauris.</p>
            </div>
            <!-- Col -->
            <div class="col-md-6 col-lg-4 mb-3">
              <h4>Are the lectures downloadable?</h4>
              <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fitur eget lacus eu, gravida blandit sem.</p>
            </div>
            <!-- Col -->
            <div class="mt-lg-10 mt-4">
              <!-- Card-->
              <div class="card">
                <!-- Card body -->
                <div class="card-body">
                  <div class="d-lg-flex justify-content-between align-items-center">
                    ...
                    <span>
                      Send us a mail via:
                      <a href="https://codescandy.com/contact-us/" target="_blank">support@example.com</a>
                    </span>
                  </div>
                </div>
              </div>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:25 GMT -->
</html>
