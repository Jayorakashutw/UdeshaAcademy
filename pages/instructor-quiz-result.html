...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/instructor-quiz-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:29 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="instructor-quiz-result.html" />

    <title>Instructor Quiz Result| Geeks - Bootstrap 5 Template</title>
  </head>
        ...
        <div class="row mb-5">
          <div class="col-12">
            <div class="d-flex flex-row align-items-center justify-content-between">
              <h3 class="mb-0">Result - React Basic Quiz</h3>
        ...
        <div class="row mb-5">
          <div class="col-12">
            <form class="row justify-content-between">
              <div class="col-xl-3 col-lg-6 col-md-7 col-12 mb-lg-0 mb-2">
                <input type="search" class="form-control" placeholder="Search" />
              </div>
              <div class="col-xl-2 col-lg-6 col-md-5 col-12">
                <!-- select -->
