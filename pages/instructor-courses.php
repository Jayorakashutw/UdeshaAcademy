...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/instructor-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:27 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  ...
  <link rel="canonical" href="instructor-courses.html" />
  ...
  <nav class="navbar navbar-expand-lg sidenav sidenav-navbar">
    ...
    <div class="db-content">
      <div class="container mb-4">
           <div class="row mb-5">
            <div class="col-12">
              <div class="d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="instructor-add-course.html" class="btn btn-primary d-flex flex-row gap-2">
                  <span>Add new Courses</span>
                  <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
           ...
           <div class="row mb-5">
            <div class="col-12">
                <form class="row gx-3 justify-content-between">
                    <div class="col-xl-3 col-lg-9 col-md-7 col-12 mb-lg-0 mb-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <a href="#"><img src="../assets/images/course/course-sass.jpg" alt="course" class="rounded img-4by3-lg"></a>
                                        </div>
                                        <div class="ms-3">
                                            <h4 class="mb-1 h5">
                                                <a href="#" class="text-inherit">Learn SCSS-Lang Courses - Basic</a>
                                            </h4>
                                            <ul class="list-inline fs-6 mb-0">
                                                <li class="list-inline-item">
                                                    <span class="align-text-bottom">
