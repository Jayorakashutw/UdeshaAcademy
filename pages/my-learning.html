...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/my-learning.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:35 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="my-learning.html" />

    <title>Dashboard My Learning| Geeks - Bootstrap 5 Template</title>
  </head>
      ...
      <div class="container mb-4">
        ...
        <div class="row g-4 mb-5">
          ...
          <div class="col-xl-3 col-md-6 col-12">
            <!-- Card -->
            <div class="card">
              <a href="learning-single.html"><img src="../assets/images/course/course-html.jpg" alt="course" class="card-img-top" /></a>
              <!-- Card body -->
              <div class="card-body d-flex flex-column gap-3">
                <h3 class="h4 mb-0"><a href="learning-single.html" class="text-inherit">HTML Courses</a></h3>
            ...
            <div class="card">
              <div class="card-body d-flex flex-column gap-4">
                ...
                <div class="row align-items-center gy-5 gy-lg-0">
                  ...
                  <div class="col-12">
                    <div>
                      <a href="learning-path-single.html" class="btn btn-primary">Resume Learning</a>
                    </div>
                  </div>
                </div>
              </div>
