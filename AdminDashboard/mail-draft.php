...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/mail-draft.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:50:30 GMT -->
<head>
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="mail-draft.html" />
    <title>Mail Draft | Geeks - Bootstrap 5 Admin Dashboard Template</title>
</head>
                            ...
                            <div class="row g-0">
                                                    ...
                                                    <a class="nav-link" href="#">
                                                        <span>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                ...
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="feather feather-tag text-success">
                                                                <path
                                ...
                                <div class="col-xxl-10 col-xl-9 col-12">
                                        ...
                                        <div class="d-md-flex justify-content-between align-items-center">
                                            <div class="d-flex flex-wrap gap-2 mb-2 mb-md-0">
                                                <div class="d-flex align-items-center border px-3 py-2 rounded-2">
                                                    ...
                                                    <div class="dropdown">
                                                        <a href="#" class="dropdown-toggle text-inherit"
                                    ...
                                    <div class="text-center py-16">
                                        <img src="assets/images/svg/draft.svg" alt="" class="img-fluid mb-3" />
                                        <p class="text-dark fs-3 fw-semibold">There is no conversation</p>
                                    </div>
                                </div>
                            </div>
                        </div>
