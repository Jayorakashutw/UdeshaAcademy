...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/project-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:37 GMT -->
<head>
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="project-list.html" />
    <link href="assets/libs/dropzone/dist/dropzone.css" rel="stylesheet " />
    <title>Project List | Geeks - Academy Admin Template</title>
  </head>
      ...
      <li class="nav-item">
        ...
        <div id="navProject" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="project-list.html">List</a>
            </li>
            <li class="nav-item">
              <a
                class="nav-link  collapsed "
                  ...
                  <table class="table mb-0 text-nowrap table-hover table-centered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="avatar-group">
                            ...
                            <span class="avatar avatar-md">
                              <!-- img -->
                              <img alt="avatar" src="assets/images/avatar/avatar-3.jpg" class="rounded-circle imgtooltip" data-template="mary " />
                              <span id="mary" class="d-none">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown dropstart">
                            <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="Dropdown2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown dropstart">
                            <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="Dropdown3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown dropstart">
                            <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="Dropdown4" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown dropstart">
                            <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="Dropdown5" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown dropstart">
                            <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="Dropdown6" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown dropstart">
                            <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="Dropdown7" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown dropstart">
                            <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="Dropdown8" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
    ...
    <div class="container">
      ...
      <form class="row needs-validation" novalidate>
        ...
        <div class="mb-3 col-md-6 col-12">
          ...
          <select class="form-select" data-choices="" id="teamMember" required>
