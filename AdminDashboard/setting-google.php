...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/setting-google.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:51 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="setting-google.html" />
    <title>Google Setting | Geeks - Bootstrap 5 Admin Dashboard Template</title>
  </head>
      ...
      <li class="nav-item">
        ...
        <div id="navSiteSetting" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="setting-google.html">Google</a>
            </li>
            <li class="nav-item">
            ...
            <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-12">
              <div class="border-bottom pb-3 mb-3">
                <div class="d-flex flex-column gap-1">
                  <h1 class="mb-0 h2 fw-bold">Google Settings</h1>
              ...
              <div class="d-flex flex-column gap-4">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form>
                      <div class="mb-3">
                        <label for="googleage" class="form-label">
                          Google Analytics Tracking ID
                          <small>(ex. UA-000000-2 )</small>
                        </label>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      <div class="mb-3">
                        <label for="trackingPage" class="form-label">Goole Map API KeY</label>
