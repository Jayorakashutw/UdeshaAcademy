...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/admin-students.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:35 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="admin-students.html" />
    <title>Students | Geeks - Bootstrap 5 Admin Dashboard Template</title>
  </head>
                        ...
                        <div class="card-body d-flex flex-column gap-6">
                          <div class="text-center d-flex flex-column align-items-center gap-3">
                            <div class="position-relative">
                              <img src="assets/images/avatar/avatar-12.jpg" class="rounded-circle avatar-xl" alt="" />
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center flex-row gap-2">
                                <div class="position-relative">
                                  <img src="assets/images/avatar/avatar-11.jpg" alt="" class="rounded-circle avatar-md" />
