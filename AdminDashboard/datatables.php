...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/datatables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:48 GMT -->
<head>
      ...
      <li class="nav-item">
        ...
        <div id="navTables" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="datatables.html">Data Tables</a>
            </li>
          </ul>
        </div>
      </li>
          ...
          <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-3 mb-3">
              <div class="d-flex flex-column gap-1">
                <h1 class="mb-0 h2 fw-bold">Data Tables</h1>
                <!-- Breadcrumb -->
          ...
          <div class="col-md-12 col-12">
            <div class="card mb-5">
              ...
              <div class="card-header">
                ...
                <p class="mb-0">
                  DataTables is a plug-in for the jQuery Javascript library. It is a highly flexible tool, built upon
                  the foundations of progressive enhancement, that adds all of these advanced
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-card">
                  <table id="dataTableButtons" class="table table-hover second" style="width: 100%">
                    <thead class="table-light">
                      <tr>
                        <th>Name</th>
                        <th>Position</th>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/datatables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:51 GMT -->
</html>