...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/setting-smpt.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:51 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="setting-smpt.html" />
    <title>Server Settings | Geeks - Bootstrap 5 Admin Dashboard Template</title>
  </head>
      ...
      <li class="nav-item">
        ...
        <div id="navSiteSetting" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="setting-smpt.html">SMPT</a>
            </li>
          </ul>
        </div>
      </li>
            ...
            <div class="col-lg-12 col-md-12 col-12">
              <div class="border-bottom pb-3 mb-3">
                <div class="d-flex flex-column gap-1">
                  <h1 class="mb-0 h2 fw-bold">SMTP Server Setting</h1>
                  <!-- Breadcrumb -->
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">SMTP Server Setting</li>
                    </ol>
                  </nav>
                </div>
              </div>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3">
                    ...
                    <!-- Mail driver -->
                    <div class="col-12 col-md-12 col-lg-6">
                      <label for="mailDriver" class="form-label">
                        Mail Driver (SMTP, Mail)
                        <span class="text-danger">*</span>
                      </label>
                    ...
                    <!-- Port number -->
                    <div class="col-12 col-md-12 col-lg-6">
                      <label for="mailPort" class="form-label">
                        Mail Port Number
                        <span class="text-danger">*</span>
                      </label>
