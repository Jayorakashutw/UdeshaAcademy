...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/order-summary.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:44 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="order-summary.html" />
    <title>Order Summary | Geeks - Academy Admin Template</title>
  </head>
      ...
      <li class="nav-item">
        ...
        <div id="navecommerce" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="order-summary.html">Order Summary</a>
            </li>
              ...
              <div class="d-flex flex-column gap-4">
                ...
                <div class="card">
                  ...
                  <div class="card-body d-flex flex-column gap-6">
                    <div class="">
                      ...
                      <p class="mb-0">We appreciate your order, were currently processing it. So hard tight and we will send you confirmation very soon!</p>
                    </div>
                    <div>
                      ...
                      <div class="row justify-content-between">
                        <!-- col -->
                        <div class="col-lg-8 col-12">
                          <div class="d-flex flex-md-row flex-column gap-md-4">
                            <!-- img -->
                            <div>
                ...
                <div class="card">
                  ...
                  <div class="card-body d-flex flex-column gap-4">
                    <div class="">
                      <!-- heading -->
                      <h2 class="mb-0">Your Order is being shipped to</h2>
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-12">
                        ...
                        <div class="d-flex flex-column gap-2">
                          ...
                          <div class="d-flex flex-column gap-3">
                            ...
                            <!-- phone -->
                            <p class="mb-0">Phone: 12309876534</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        ...
                        <div class="d-flex flex-column gap-3">
                          ...
                          <div class="d-flex flex-column gap-2">
                            <div>
                              <img src="../assets/images/creditcard/visa.svg" alt="" class="" />
                            </div>
                            <div>
