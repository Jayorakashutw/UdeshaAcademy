...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:43 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="shopping-cart.html" />
      ...
      <li class="nav-item">
        ...
        <div id="navecommerce" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="shopping-cart.html">Shopping Cart</a>
            </li>
            <li class="nav-item">
