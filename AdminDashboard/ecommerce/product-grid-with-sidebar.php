...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/product-grid-with-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:39 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="product-grid-with-sidebar.html" />
            ...
            <li class="nav-item">
              ...
              <div id="navproduct" class="collapse  show " data-bs-parent="#navProduct">
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a class="nav-link  active " href="product-grid-with-sidebar.html">Grid Sidebar</a>
                  </li>
                  <li class="nav-item">
                ...
                <div>
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Product Grid with Sidebar</li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-8 col-xl-9 col-12">
              <div>
                ...
                <div class="row justify-content-md-between flex-md-row flex-column gap-1 gap-md-0 mb-4">
                  ...
                  <div class="col-xxl-6 col-lg-5 col-md-12 col-12">
                    <!-- row -->
              ...
              <div class="card">
                ...
                <div class="card-body d-flex flex-column gap-3">
                  ...
                  <div>
                    ...
                    <!-- form check -->
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="female" checked />
                ...
                <div class="card-body border-top d-flex flex-column gap-3">
                  ...
                  <div>
                    ...
                    <!-- form check radio -->
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="flexRadioDefault" id="shoes" checked />
                      <label class="form-check-label" for="shoes">Shoes</label>
                    </div>
                    <!-- form check radio -->
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="flexRadioDefault" id="bags" checked />
                      <label class="form-check-label" for="bags">Bags</label>
                    </div>
                    <!-- form check radio -->
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="flexRadioDefault" id="glasses" checked />
                    ...
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="flexRadiorating2">
                        <span>
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-star-fill text-secondary align-baseline" viewBox="0 0 16 16">
                            <path
                              d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"></path>
                          </svg>
                        </span>
                ...
                <div class="card-body border-top d-flex flex-column gap-3">
                  ...
                  <div class="d-flex flex-column gap-2">
                    <!-- form check -->
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="priceOne" />
                      <label class="form-check-label" for="priceOne">$25 to $75</label>
                    </div>
                    <!-- form check -->
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="priceTwo" checked="" />
                      <label class="form-check-label" for="priceTwo">$75 to $175</label>
                    </div>
                    <!-- form check -->
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="priceThree" />
                      <label class="form-check-label" for="priceThree">$175 to $299</label>
                    </div>
                    <!-- form check -->
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="priceFour" />
                      <label class="form-check-label" for="priceFour">$300 to $499</label>
                    </div>
                  </div>
                </div>
              </div>
