...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:44 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <title>Customers | Geeks - Academy Admin Template</title>
  </head>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
              ...
              <div class="border-bottom pb-3 mb-3 d-flex flex-lg-row flex-column gap-2 align-items-lg-center justify-content-between">
                <div>
                  <h1 class="mb-0 h2 fw-bold">Customers</h1>
                  <!-- Breadcrumb -->
                ...
                <div class="d-flex align-items-center">
                  ...
                  <a href="add-customer.html" class="btn btn-primary me-2">Add Customer</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card rounded-3">
                ...
                <div class="p-4 row">
                  ...
                  <form class="d-flex align-items-center col-12 col-md-8 col-lg-3">
                    ...
                    <input type="search" class="form-control ps-6" placeholder="Filter Customers" />
                  </form>
                </div>
                  ...
                  <table class="table mb-0 text-nowrap table-centered table-hover table-with-checkbox">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-1.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            <span>Harold Gonzalez</span>
                          </a>
                        </td>
                        <td class="d-flex flex-row gap-2">
                          <span><i class="fe fe-map-pin me-1"></i></span>
                        ...
                        <td class="d-flex flex-row gap-3">
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="one">
                            <i class="fe fe-edit fs-5"></i>

                            <div id="one" class="d-none">
                              <h6 class="mb-0 text-white">Edit</h6>
                            </div>
                          </a>
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="two">
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-5.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            Anthony Anderson
                          </a>
                        </td>
                        <td>
                        ...
                        <td class="d-flex flex-row gap-3">
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="three">
                            <i class="fe fe-edit fs-5"></i>
                          ...
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="four">
                            <i class="fe fe-trash-2 fs-5"></i>
                      ...
                      <tr>
                        ...
                        <td class="d-flex flex-row gap-3">
                          ...
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="six">
                            <i class="fe fe-trash-2 fs-5"></i>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-10.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            Steve Nelson
                          </a>
                        </td>
                        <td class="d-flex flex-row gap-2">
                        ...
                        <td class="d-flex flex-row gap-3">
                          ...
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="eight">
                            <i class="fe fe-trash-2 fs-5"></i>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-3.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            Kimberly Sullivan
                          </a>
                        </td>
                        <td class="d-flex flex-row gap-2">
                          <span><i class="fe fe-map-pin me-1"></i></span>
                          <span>Gundamulda, Australia</span>
                        </td>
                        ...
                        <td class="d-flex flex-row gap-3">
                          ...
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="ten">
                            <i class="fe fe-trash-2 fs-5"></i>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-7.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            Susan Pugh
                          </a>
                        </td>
                        <td class="d-flex flex-row gap-2">
                          <span><i class="fe fe-map-pin me-1"></i></span>
                          <span>Gradignan, France</span>
                        </td>
                        ...
                        <td class="d-flex flex-row gap-3">
                          ...
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="twelve">
                            <i class="fe fe-trash-2 fs-5"></i>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-8.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            Elliott Potts
                          </a>
                        </td>
                        <td class="d-flex flex-row gap-2">
                          <span><i class="fe fe-map-pin me-1"></i></span>
                          <span>Regina, Canada</span>
                        </td>
                        ...
                        <td class="d-flex flex-row gap-3">
                          ...
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="fourteen">
                            <i class="fe fe-trash-2 fs-5"></i>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-11.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            Richard Beaudry
                          </a>
                        </td>
                        <td class="d-flex flex-row gap-2">
                        ...
                        <td class="d-flex flex-row gap-3">
                          ...
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="sixteen">
                            <i class="fe fe-trash-2 fs-5"></i>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-12.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            Henry Saxton
                          </a>
                        </td>
                        <td class="d-flex flex-row gap-2">
                        ...
                        <td class="d-flex flex-row gap-3">
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="fifteen2">
                            <i class="fe fe-edit fs-5"></i>

                            <div id="fifteen2" class="d-none">
                              <h6 class="mb-0 text-white">Edit</h6>
                            </div>
                          </a>
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="sixteen2">
                            <i class="fe fe-trash-2 fs-5"></i>
                            <div id="sixteen2" class="d-none">
                              <h6 class="mb-0 text-white">Delete</h6>
                            </div>
                          </a>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="text-body d-flex flex-row gap-2">
                            <span class=""><img src="../assets/images/avatar/avatar-9.jpg" class="avatar avatar-xs rounded-circle" alt="" /></span>
                            Juanita Diener
                          </a>
                        </td>
                        <td class="d-flex flex-row gap-2">
                          <span><i class="fe fe-map-pin"></i></span>
                          <span>Idaho, United States</span>
                        </td>
                        ...
                        <td class="d-flex flex-row gap-3">
                          ...
                          <a href="#" class="text-body text-primary-hover texttooltip" data-template="eighteen">
                            <i class="fe fe-trash-2 fs-5"></i>
