...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:43 GMT -->
<head>
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <title>Checkout | Geeks - Academy Admin Template</title>
  </head>
                    ...
                    <div class="bs-stepper-header p-0 bg-transparent" role="tablist">
                      <div class="step" data-target="#test-l-1">
                        <button type="button" class="step-trigger" role="tab" id="stepperFormtrigger1" aria-controls="test-l-1">
                          <span class="bs-stepper-circle p-2 me-2"><i class="fe fe-user"></i></span>
                      ...
                      <div class="step" data-target="#test-l-2">
                        <button type="button" class="step-trigger" role="tab" id="stepperFormtrigger2" aria-controls="test-l-2">
                          <span class="bs-stepper-circle p-2 me-2"><i class="fe fe-shopping-bag"></i></span>
                      ...
                      <div class="step" data-target="#test-l-3">
                        <button type="button" class="step-trigger" role="tab" id="stepperFormtrigger3" aria-controls="test-l-3">
                          <span class="bs-stepper-circle p-2 me-2"><i class="fe fe-credit-card"></i></span>
                      ...
                      <form onSubmit="return false">
                        ...
                        <div id="test-l-1" role="tabpanel" class="bs-stepper-pane fade" aria-labelledby="stepperFormtrigger1">
                            ...
                            <div class="row gx-3">
                              ...
                              <div class="mb-3 col-12">
                                <div class="form-check">
                                  ...
                                  <label class="form-check-label" for="shipAddress">Ship to different address ?</label>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="d-flex justify-content-end">
                            <button class="btn btn-primary" onclick="stepperForm.next()">
                              Proceed to Shipping
                              <i class="fe fe-shopping-bag ms-1"></i>
                            </button>
                          </div>
                        </div>
                        <!-- Content two -->
                        <div id="test-l-2" role="tabpanel" class="bs-stepper-pane fade" aria-labelledby="stepperFormtrigger2">
                          ...
                          <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <a href="#" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#addNewAddress">Add new address</a>
                          </div>
                          <!-- row -->
                          <div class="row">
                          ...
                          <div>
                            ...
                            <div class="card card-bordered shadow-none mb-2">
                              ...
                              <div class="card-body">
                                ...
                                <div class="d-flex">
                                  <div class="form-check">
                                    <input class="form-check-input" type="radio" name="flexRadioDefault" id="freeDelivery" />
                                    <label class="form-check-label ms-2" for="freeDelivery"></label>
                                  </div>
                                  <div>
                                ...
                                <div class="d-md-flex">
                                  ...
                                  <div class="d-flex justify-content-between align-items-center w-100">
                                    <div class="d-flex align-items-start">
                                      <!-- img -->
                                      <img src="../assets/images/svg/payment-logo-fedex.svg" alt="" />
                                      <!-- text -->
                                      <div class="ms-2">
                              ...
                              <div class="card-body">
                                <div class="d-md-flex">
                                  ...
                                  <div class="d-flex justify-content-between align-items-center w-100">
                                    <!-- img -->
                                    <div class="d-flex align-items-start">
                                      <img src="../assets/images/svg/payment-logo-dhl.svg" alt="" />
                                      <!-- text -->
                                      <div class="ms-2">
                          ...
                          <div class="d-md-flex justify-content-between mt-4">
                            <button class="btn btn-outline-primary mb-2 mb-md-0" onclick="stepperForm.previous()">Back to Info</button>
                            <!-- Button -->
                            <button class="btn btn-primary" onclick="stepperForm.next()">
                              Continue to Payment
                        ...
                        <div id="test-l-3" role="tabpanel" class="bs-stepper-pane fade" aria-labelledby="stepperFormtrigger3">
                            ...
                            <div class="card-body">
                              <div class="d-flex">
                                ...
                                <div>
                                  ...
                                  <p class="mb-0 fs-6">You will be redirected to PayPal website to complete your purchase securely.</p>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="card-body">
                              <div class="d-flex mb-4">
                                ...
                                <div>
                                  ...
                                  <p class="mb-0 fs-6">Safe money transfer using your bank accou k account. We support Mastercard tercard, Visa, Discover and Stripe.</p>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-md-6 col-12">
                                  ...
                                  <div class="mb-3 mb-lg-0">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter your first name" id="nameoncard" />
                                  </div>
                                </div>
                            ...
                            <div class="card-body">
                              ...
                              <div class="d-flex">
                                ...
                                <div>
                                  ...
                                  <p class="mb-0 fs-6">You will be redirected to Payoneer website to complete your purchase securely.</p>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="d-flex justify-content-between">
                            <!-- Button -->
                            <button class="btn btn-outline-primary mt-3" onclick="stepperForm.previous()">Back to shipping</button>
                            <!-- Button -->
                            <button type="submit" class="btn btn-primary mt-3" onclick=" location.href='order-summary.html' ">Complete Order</button>
                          </div>
                        </div>
                      </form>
                    </div>
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-row gap-4">
                    <div>
                      <img src="../assets/images/ecommerce/ecommerce-img-9.jpg" alt="" class="img-4by3-xl rounded" />
                    </div>
                    <div class="d-flex flex-column gap-2">
                      <div class="d-flex flex-column gap-1">
                        <h4 class="mb-0 text-primary-hover">Nike Black and White</h4>
        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="row">
              <!-- input -->
              <div class="mb-3 col-md-6">
                <label class="form-label" for="firstNameForAddress">First Name</label>
                <input type="text" class="form-control" placeholder="Enter first name" id="firstNameForAddress" />
              </div>
              <!-- input -->
              <div class="mb-3 col-md-6">
                <label class="form-label" for="lastNameForAddress">Last Name</label>
                <input type="text" class="form-control" placeholder="Enter last name" id="lastNameForAddress" />
              </div>
              <!-- input -->
              <div class="mb-3 col-md-6">
                <label class="form-label" for="emailForAddress">Email (Optional)</label>
                <input type="email" class="form-control" placeholder="Enter email address" id="emailForAddress" />
              </div>
              <!-- input -->
              <div class="mb-3 col-md-6">
                <label class="form-label" for="phoneForAddress">Phone</label>
                <input type="text" class="form-control" placeholder="Enter phone number" id="phoneForAddress" />
              </div>
              <!-- input -->
              <div class="mb-3 col-6">
                <label class="form-label" for="addressForAddress">Address</label>
                <input type="text" class="form-control" placeholder="Enter address" id="addressForAddress" />
              </div>
              <!-- input -->
              <div class="mb-3 col-6">
                <label class="form-label" for="townForAddress">Town / City</label>
                <input type="text" class="form-control" placeholder="Enter City" id="townForAddress" />
              </div>
              <!-- input -->
              <div class="mb-3 col-6">
                <label class="form-label" for="stateForAddress">State</label>
                <input type="text" class="form-control" placeholder="Enter State" id="stateForAddress" />
              </div>
              <!-- input -->
              <div class="mb-3 col-6">
                <label class="form-label" for="zipForAddress">Zip / Postal Code</label>
                <input type="text" class="form-control" placeholder="Zip / Postal Code" id="zipForAddress" />
              </div>
              <!-- select -->
              <div class="mb-3 col-12">
                <label class="form-label" for="contryForAddress">Country</label>
                <select class="form-select" data-choices="" id="contryForAddress">
                  <option selected>Select Country</option>
                  <option value="1">India</option>
                  <option value="2">UK</option>
                  <option value="3">US</option>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:44 GMT -->
</html>
