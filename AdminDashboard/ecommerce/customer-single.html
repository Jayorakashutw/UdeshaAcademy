...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/customer-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:44 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="customer-single.html" />
    <title>Customer Single | Geeks - Academy Admin Template</title>
  </head>
      ...
      <li class="nav-item">
        ...
        <div id="navecommerce" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="customer-single.html">Customer Single</a>
            </li>
            <li class="nav-item">
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
              ...
              <div class="border-bottom pb-3 mb-3 d-flex flex-md-row flex-column gap-3 align-items-md-center justify-content-between">
                <div>
                  <h1 class="mb-0 h2 fw-bold">Customer Single</h1>
                  <!-- Breadcrumb -->
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Customer Single</li>
                    </ol>
                  </nav>
                </div>
                <div>
          ...
          <div class="row gy-4">
            <div class="col-lg-8 col-12">
              <div class="d-flex flex-column gap-4">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center flex-row gap-4">
                      ...
                      <div class="d-flex flex-column gap-1">
                        <!-- text -->
                        <h3 class="mb-0">Harold Gonzalez</h3>
                ...
                <div class="card">
                  <!-- card body -->
                  <div class="card-header"><h4 class="mb-0">Recent Order</h4></div>
                  <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between">
                            <div>
                              <a href="#" class="text-inherit">
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column gap-lg-3 gap-2">
                                  <!-- img -->
                                  <div>
                            ...
                            <div>
                              <!-- button -->
                              <a href="#" class="btn btn-light-danger text-danger btn-sm">Refund</a>
                            </div>
                          </div>
                        </div>
                      </li>
