...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/basic-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:47 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="basic-table.html" />
    <title>Tables | Geeks - Academy Admin Template</title>
  </head>
...
<nav class="navbar-vertical navbar">
  <div class="vh-100" data-simplebar>
    ...
    <ul class="navbar-nav flex-column" id="sideNavbar">
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link " href="#" data-bs-toggle="collapse" data-bs-target="#navTables" aria-expanded="false" aria-controls="navTables">
          <i class="nav-icon fe fe-database me-2"></i>
          Tables
        </a>
        <div id="navTables" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link  active " href="basic-table.html">Basic</a>
            </li>
            <li class="nav-item">
            ...
            <div class="col-lg-12 col-md-12 col-12">
              ...
              <div class="border-bottom pb-3 mb-3">
                <div class="d-flex flex-column gap-1">
                  <h1 class="mb-0 h2 fw-bold">Tables</h1>
                  <!-- Breadcrumb -->
          ...
          <div class="row gy-5">
                  ...
                  <table class="table text-nowrap mb-0 table-centered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownOne" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThree" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td class="align-middle border-bottom-0">Sept 20</td>
                        <td class="align-middle border-bottom-0"><span class="badge bg-warning">Medium</span></td>
                        <td class="align-middle border-bottom-0">
                          <div class="avatar-group">
                            <span class="avatar avatar-sm">
                        ...
                        <td class="align-middle border-bottom-0">
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFour" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownFour">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="card">
                ...
                <!-- table  -->
                <div class="table-responsive">
                  <table class="table table-dark text-nowrap mb-0">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="lh-1">Dropbox Design System</div>
                          </div>
                        </td>
                        <td>June 2</td>
                        <td><span class="badge bg-warning">Medium</span></td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFive" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownFive">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="lh-1">Slack UI Design</div>
                          </div>
                        </td>
                        <td>June 12</td>
                        <td><span class="badge bg-danger">High</span></td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownSix" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownSix">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-3">
                            <div>
                              <div>
                                <img src="assets/images/brand/github-logo.svg" alt="" class="text-inverse" />
                              </div>
                            </div>
                            <div class="lh-1">GitHub Satellite</div>
                          </div>
                        </td>
                        <td>Aug 14</td>
                        <td><span class="badge bg-info">Low</span></td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownSeven" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownSeven">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="lh-1">3D Character Modelling</div>
                          </div>
                        </td>
                        <td>Sept 20</td>
                        <td><span class="badge bg-warning">Medium</span></td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownEight" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownEight">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="card">
                <!-- card header  -->
                <div class="card-header">
                  <h4 class="mb-1">Table Head Options</h4>
                  <p class="mb-0">
                  ...
                  <table class="table text-nowrap mb-0 table-centered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownNine" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTen" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTen">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownEleven" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownEleven">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td class="align-middle border-bottom-0">
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwelve" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwelve">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="card">
                <!-- card header  -->
                <div class="card-header">
                  <h4 class="mb-1">Table Striped</h4>
                  <p class="mb-0">
                    Use
                  ...
                  <table class="table table-striped text-nowrap mb-0 table-centered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFourteen" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownFourteen">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFifteen" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownFifteen">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td class="align-middle border-bottom-0">
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownSixteen" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownSixteen">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="card">
                ...
                <div class="card-header border-bottom-0">
                  <h4 class="mb-1">Table Bordered</h4>
                  <p class="mb-0">
                    Add
                    <code class="highlighter-rouge">.table-bordered</code>
                  ...
                  <table class="table table-bordered text-nowrap mb-0 table-centered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownSeventeen" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                      ...
                      <tr>
                        ...
                        <td class="align-middle">
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownEighteen" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownEighteen">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownNineteen" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownNineteen">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td class="align-middle border-bottom-0">
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwenty" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwenty">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="card">
                <!-- card header  -->
                <div class="card-header border-bottom-0">
                  <h4 class="mb-1">Table Bordered Color</h4>
                  <p class="mb-0">
                  ...
                  <table class="table table-bordered border-primary text-nowrap mb-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwentyOne" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwentyOne">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwentyTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwentyTwo">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwentyThree" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwentyThree">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td class="align-middle border-bottom-0">
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwentyFour" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwentyFour">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="card">
                <!-- card header  -->
                <div class="card-header">
                  <h4 class="mb-1">Table Borderless</h4>
                  <p class="mb-0">
                    Add
                  ...
                  <table class="table table-borderless text-nowrap mb- table-centered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwentyFive" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwentyFive">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwentySix" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwentySix">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownTwentyNine" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownTwentyNine">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td class="align-middle border-bottom-0">
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirty" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirty">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                  ...
                  <table class="table table-hover text-nowrap mb-0 table-centered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirtyTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirtyTwo">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirtyThree" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirtyThree">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td class="align-middle border-bottom-0">
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirtyFour" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirtyFour">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="card">
                <!-- card header  -->
                <div class="card-header">
                  <h4 class="mb-1">Nesting</h4>
                  <p class="mb-0">Border styles, active styles, and table variants are not inherited by nested tables..</p>
                </div>
                <!-- table  -->
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 table-centered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFortyThree" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownFortyThree">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                          ...
                          <table class="table text-nowrap">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <div class="dropdown">
                                    <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFortyFour" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <i class="fe fe-more-vertical"></i>
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="dropdownFortyFour">
                                      <a class="dropdown-item" href="#">Action</a>
                                      <a class="dropdown-item" href="#">Another action</a>
                                      <a class="dropdown-item" href="#">Something else here</a>
                                    </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="dropdown">
                                    <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFortyFive" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <i class="fe fe-more-vertical"></i>
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="dropdownFortyFive">
                                      <a class="dropdown-item" href="#">Action</a>
                                      <a class="dropdown-item" href="#">Another action</a>
                                      <a class="dropdown-item" href="#">Something else here</a>
                                    </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFortySix" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownFortySix">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                  ...
                  <table class="table text-nowrap mb-0 table-centered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirtyNine" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirtyNine">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr class="table-active">
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownForty" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownForty">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFortyOne" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownFortyOne">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownFortyTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownFortyTwo">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                  ...
                  <table class="table table-sm text-nowrap mb-0 table-centered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirtyFive" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirtyFive">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirtySix" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirtySix">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirtySeven" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirtySeven">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-body text-primary-hover" href="#" role="button" id="dropdownThirtyEight" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownThirtyEight">
                              <a class="dropdown-item" href="#">Action</a>
                              <a class="dropdown-item" href="#">Another action</a>
                              <a class="dropdown-item" href="#">Something else here</a>
                            </div>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/basic-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:48 GMT -->
</html>
