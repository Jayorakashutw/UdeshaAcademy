                    ...
                    <li class="nav-item">
                        ...
                        <div id="navCourses" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="admin-course-overview.html">Category</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="admin-course-category.html">Course</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="admin-course-category-single.html">Topic</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="admin-course-overview.html">Course Content</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="admin-course-category.html">Course List</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                                ...
                                <div>
                                    <div class="dropdown dropstart">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="courseDropdown1">
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <i class="fe fe-external-link dropdown-item-icon"></i> Export
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <i class="fe fe-mail dropdown-item-icon"></i> Email Report
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <i class="fe fe-download dropdown-item-icon"></i> Download
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row gy-4">
                    <div class="col-xl-4 col-lg-12 col-md-12 col-12">
                        ...
                        <div class="card h-100">
                            ...
                            <span class="text-dark me-1 fw-semibold">42</span> Courses
                                                </span>
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">1,10,124</span> Students
                                                </span>
                                                <span class="fs-6">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            ...
                                            <div class="col ms-n3">
                                                ...
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">12</span> Courses
                                                </span>
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">21,567</span> Students
                                                </span>
                                                <span class="fs-6">
                            <span class="text-dark me-1 fw-semibold">22,000</span> Reviews
                                                </span>
                                            </div>
                                            <div class="col-auto">
                                                <span class="dropdown dropstart">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            ...
                                            <div class="col ms-n3">
                                                ...
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">32</span> Courses
                                                </span>
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">11,604</span> Students
                                                </span>
                                                <span class="fs-6">
                            <span class="text-dark me-1 fw-semibold">12,230</span> Reviews
                                                </span>
                                            </div>
                                            <div class="col-auto">
                                                <span class="dropdown dropstart">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            ...
                                            <div class="col ms-n3">
                                                ...
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">23</span> Courses
                                                </span>
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">6,304</span> Students
                                                </span>
                                                <span class="fs-6">
                            <span class="text-dark me-1 fw-semibold">56,000</span> Reviews
                                                </span>
                                            </div>
                                            <div class="col-auto">
                                                <span class="dropdown dropstart">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            ...
                                            <div class="col ms-n3">
                                                ...
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">14</span> Courses
                                                </span>
                                                <span class="me-2 fs-6">
                            <span class="text-dark me-1 fw-semibold">8,000</span> Students
                                                </span>
                                                <span class="fs-6">
                            <span class="text-dark me-1 fw-semibold">33,000</span> Reviews
                                                </span>
                                            </div>
                                            <div class="col-auto">
                                                <span class="dropdown dropstart">
                                        ...
                                        <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                            ...
                                            <div class="col-md-8 col-10">
                                                <div class="d-flex flex-column gap-2">
                                                    <a href="#">
                                                        <h5 class="text-primary-hover mb-0">Revolutionize how you build the web...</h5>
                                                    </a>
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                            ...
                                            <div class="col-md-8 col-10">
                                                <div class="d-flex flex-column gap-2">
                                                    <a href="#">
                                                        <h5 class="text-primary-hover mb-0">Guide to Static Sites with Gatsby.js</h5>
                                                    </a>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="../assets/images/avatar/avatar-8.jpg" alt="" class="rounded-circle avatar-xs" />
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                            ...
                                            <div class="col-md-8 col-10">
                                                <div class="d-flex flex-column gap-2">
                                                    <a href="#">
                                                        <h5 class="text-primary-hover mb-0">The Modern JavaScript Courses</h5>
                                                    </a>
                                                    <div class="d-flex align-items-center gap-2">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                            ...
                                            <div class="col-md-8 col-10">
                                                <div class="d-flex flex-column gap-2">
                                                    <a href="#">
                                                        <h5 class="text-primary-hover mb-0">Online WordPress Courses Become an Expert Today‎</h5>
                                                    </a>
                                                    <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="col ms-n2">
                                                <div class="d-flex flex-column gap-1">
                                                    <div>
                                                        ...
                                                        <p class="mb-0">Just buy the courses”Build React Application Tutorial”</p>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="col ms-n2">
                                                <div class="d-flex flex-column gap-1">
                                                    <div>
                                                        ...
                                                        <p class="mb-0">Comment on “Bootstrap Tutorial” Says “Hi,I m irene...</p>
                                                    </div>
                                                    <div>
