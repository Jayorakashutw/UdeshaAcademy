...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/admin-cms-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:35 GMT -->
        ...
        <main id="page-content">
            ...
            <section class="container-fluid p-4">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="border-bottom pb-3 mb-3 d-flex align-items-center justify-content-between">
                            <div class="d-flex flex-column gap-1">
                                <h1 class="mb-0 h2 fw-bold">CMS Dashboard</h1>
                                <!-- Breadcrumb -->
                            ...
                            <div class="card-body d-flex flex-column gap-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="lh-1 d-flex flex-column gap-1">
                                        <h2 class="h1 fw-bold mb-0">2,000</h2>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body d-flex flex-column gap-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="lh-1 d-flex flex-column gap-1">
                                        <h2 class="h1 fw-bold mb-0">367</h2>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body d-flex flex-column gap-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="lh-1 d-flex flex-column gap-1">
                                        <h2 class="h1 fw-bold mb-0">13,234</h2>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body d-flex flex-column gap-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="lh-1 d-flex flex-column gap-1">
                                        <h2 class="h1 fw-bold mb-0">120</h2>
                ...
                <div class="row">
                    ...
                    <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="courseDropdown1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <table class="table mb-0 text-nowrap table-hover table-centered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge-dot bg-warning me-1 d-inline-block align-middle"></span> Draft
                                            </td>
                                            <td>
                                                <span class="dropdown dropstart">
                            ...
                            <span class="dropdown-menu" aria-labelledby="courseDropdown3">
                              <span class="dropdown-header">Settings</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge-dot bg-success me-1 d-inline-block align-middle"></span> Published
                                            </td>
                                            <td>
                                                <span class="dropdown dropstart">
                            ...
                            <span class="dropdown-menu" aria-labelledby="courseDropdown6">
                              <span class="dropdown-header">Settings</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-2">
                                                    <img src="../assets/images/avatar/avatar-15.jpg" alt="" class="rounded-circle avatar-xs" />
                                                    <h5 class="mb-0">Misty Smaln</h5>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="badge-dot bg-info me-1 d-inline-block align-middle"></span> Schedule
                                            </td>
                                            <td>
                                                <span class="dropdown dropstart">
                            ...
                            <span class="dropdown-menu" aria-labelledby="courseDropdown7">
                              <span class="dropdown-header">Settings</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center flex-row gap-2">
                                                    <img src="../assets/images/avatar/avatar-12.jpg" alt="" class="rounded-circle avatar-xs" />
                            ...
                            <span class="dropdown-menu" aria-labelledby="courseDropdown8">
                              <span class="dropdown-header">Settings</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge-dot bg-danger me-1 d-inline-block align-middle"></span> Deleted
                                            </td>
                                            <td>
                                                <span class="dropdown dropstart">
