...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/setting-social-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:51 GMT -->
<head>
        <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
        ...
        <link rel="canonical" href="setting-social-login.html">
        <title>Social Login Setting | Geeks - Bootstrap 5 Admin Dashboard Template</title>
    </head>
  ...
  <div class="vh-100" data-simplebar>
    ...
    <ul class="navbar-nav flex-column" id="sideNavbar">
      ...
      <li class="nav-item">
        ...
        <div id="navSiteSetting" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="setting-social-login.html">Social Login</a>
            </li>
            <li class="nav-item">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="border-bottom pb-3 mb-3">
                                <div class="d-flex flex-column gap-1">
                                    <h1 class="mb-0 h2 fw-bold">Social Login Settings</h1>
                                    <!-- Breadcrumb -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">
                                        ...
                                        <span>Facebook Login Settings</span>
                                    </h4>
                                    <!-- Custom Control -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <!-- Key -->
                                        <div class="mb-3 mb-4">
                                            <label for="consumerKey1" class="form-label">
                                                App Secret
                                                <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <!-- URL -->
                                        <div class="mb-3 mb-4">
                                            <label for="consumerSecret1" class="form-label">Login Redirect URL</label>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">
                                        ...
                                        <span>Twitter Login Settings</span>
                                    </h4>
                                    <!-- Custom control -->
                                    <div class="form-check form-switch">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <!-- Key -->
                                        <div class="mb-3 mb-4">
                                            <label for="twiiterAppid" class="form-label">
                                        ...
                                        <!-- Secret key -->
                                        <div class="mb-3 mb-4">
                                            <label for="consumerKey2" class="form-label">
                                        ...
                                        <!-- URL -->
                                        <div class="mb-3 mb-4">
                                            <label for="consumerSecret2" class="form-label">Login Redirect URL</label>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">
                                        <span class="me-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-google text-primary" viewBox="0 0 16 16">
                                                <path
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <!-- Client id -->
                                        <div class="mb-3 mb-4">
                                            <label for="googleAppid" class="form-label">
                                                Client ID
                                                <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <!-- Key -->
                                        <div class="mb-3 mb-4">
                                            <label for="consumerKey3" class="form-label">
                                                Client Secret Key
                                                <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <!-- URL -->
                                        <div class="mb-3 mb-4">
                                            <label for="consumerSecret3" class="form-label">Login Redirect URL</label>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">
                                        ...
                                        <span>LinkedIn Login API Settings</span>
                                    </h4>
                                    <!-- Custom Control -->
                                    <div class="form-check form-switch">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <!-- Client id -->
                                        <div class="mb-3 mb-4">
                                            <label for="linkedinAppid" class="form-label">
                                                Client ID
                                                <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <!-- Key -->
                                        <div class="mb-3 mb-4">
                                            <label for="consumerKey4" class="form-label">
                                                Client Secret Key
                                                <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <!-- Login -->
                                        <div class="mb-3 mb-4">
                                            <label for="consumerSecret4" class="form-label">Login Redirect URL</label>
