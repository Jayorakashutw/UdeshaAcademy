...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/project-task.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:37 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="project-task.html" />
    <title>Project Task | Geeks - Academy Admin Template</title>
  </head>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    ...
                    <div>
                      <!-- dropdown  -->
                      <span class="dropdown dropstart">
                        <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="DropdownTwelve" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="fe fe-more-vertical"></i>
                        </a>
                  ...
                  <table class="table text-nowrap mb-0 table-hover table-centered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="dropdown dropstart">
                            <a class="btn-icon btn btn-ghost btn-sm rounded-circle" href="#" role="button" id="DropdownSeventeen" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fe fe-more-vertical"></i>
                            </a>
