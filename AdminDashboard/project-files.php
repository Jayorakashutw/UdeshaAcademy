...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/project-files.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:37 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="project-files.html" />
    <title>Project Files | Geeks - Academy Admin Template</title>
  </head>
                ...
                <div class="table-responsive overflow-y-hidden">
                  <table class="table mb-0 text-nowrap table-hover table-centered">
                    ...
                    <tbody>
                        ...
                        <td>
                          <div class="d-flex align-items-center flex-row gap-3">
                            <div class="icon-shape icon-lg rounded-3 bg-light-info">
                              <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-image text-info" viewBox="0 0 16 16">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center d-flex flex-row gap-3">
                            <div class="icon-shape icon-lg rounded-3 bg-light-success">
                              <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-word text-success" viewBox="0 0 16 16">
                                  <path
                        ...
                        <td>
                          <div class="d-flex align-items-center flex-row gap-3">
                            <div class="icon-shape icon-lg rounded-3 bg-light-danger">
                              <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-ppt text-danger" viewBox="0 0 16 16">
                        ...
                        <td>
                          <div class="d-flex align-items-center flex-row gap-3">
                            <div class="icon-shape icon-lg rounded-3 bg-light-warning">
                              <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-text text-warning" viewBox="0 0 16 16">
                                  <path
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center flex-row gap-3">
                            <div class="icon-shape icon-lg rounded-3 bg-light-danger">
                              <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-earmark-slides text-danger" viewBox="0 0 16 16">
                                  <path
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center flex-row gap-3">
                            <div class="icon-shape icon-lg rounded-3 bg-light-success">
                              <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-excel text-success" viewBox="0 0 16 16">
                                  <path
