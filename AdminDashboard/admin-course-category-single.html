...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/admin-course-category-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:34 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="admin-course-category-single.html" />
      ...
      <li class="nav-item">
        ...
        <div id="navCourses" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="admin-course-category-single.html">Category Single</a>
            </li>
          </ul>
        </div>
      </li>
                  ...
                  <table class="table mb-0 text-nowrap table-hover table-centered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-cente0 flex-row gap-2">
                        ...
                        <td>
                          <a href="#" class="text-inherit">
                            <div class="d-flex align-items-center flex-row gap-3">
                              ...
                              <div class="d-flex flex-column flex-column gap-1">
