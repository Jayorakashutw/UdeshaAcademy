...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/project-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:36 GMT -->
<head>
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <title>Project Grid | Geeks - Academy Admin Template</title>
  </head>
                  ...
                  <div class="d-flex flex-column gap-4">
                    <div class="d-flex flex-column gap-3">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                          <div class="dropdown dropstart">
                            <a href="#" class="btn-icon btn btn-ghost btn-sm rounded-circle" id="dropdownProjectTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="bi bi-three-dots-vertical"></i>
                            </a>
                  ...
                  <div class="d-flex flex-column gap-4">
                    <div class="d-flex flex-column gap-3">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                          <div class="dropdown dropstart">
                            <a href="#" class="btn-icon btn btn-ghost btn-sm rounded-circle" id="dropdownProjectThree" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="bi bi-three-dots-vertical"></i>
                            </a>
                  ...
                  <div class="d-flex flex-column gap-4">
                    <div class="d-flex flex-column gap-3">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                          <div class="dropdown dropstart">
                            <a href="#" class="btn-icon btn btn-ghost btn-sm rounded-circle" id="dropdownProjectEight" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="bi bi-three-dots-vertical"></i>
                            </a>
                  ...
                  <div class="d-flex flex-column gap-4">
                    <div class="d-flex flex-column gap-3">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex">
                          <div class="dropdown dropstart">
                            <a href="#" class="btn-icon btn btn-ghost btn-sm rounded-circle" id="dropdownProjectFour" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="bi bi-three-dots-vertical"></i>
                            </a>
                  ...
                  <div class="d-flex flex-column gap-4">
                    <div class="d-flex flex-column gap-3">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex">
                          <div class="dropdown dropstart">
                            <a href="#" class="btn-icon btn btn-ghost btn-sm rounded-circle" id="dropdownProjectFive" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="bi bi-three-dots-vertical"></i>
                            </a>
                  ...
                  <div class="d-flex flex-column gap-4">
                    <div class="d-flex flex-column gap-3">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex">
                          <div class="dropdown dropstart">
                            <a href="#" class="btn-icon btn btn-ghost btn-sm rounded-circle" id="dropdownProjectSix" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="bi bi-three-dots-vertical"></i>
                            </a>
                  ...
                  <div class="d-flex flex-column gap-4">
                    <div class="d-flex flex-column gap-3">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex">
                          <div class="dropdown dropstart">
                            <a href="#" class="btn-icon btn btn-ghost btn-sm rounded-circle" id="dropdownProjectEleven" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="bi bi-three-dots-vertical"></i>
                            </a>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/project-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:37 GMT -->
</html>
