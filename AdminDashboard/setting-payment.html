...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/setting-payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:51 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="setting-payment.html" />
    <title>Payment Settings | Geeks - Bootstrap 5 Admin Dashboard Template</title>
  </head>
      ...
      <li class="nav-item">
        ...
        <div id="navSiteSetting" class="collapse  show " data-bs-parent="#sideNavbar">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link  active " href="setting-payment.html">Payment</a>
            </li>
            <li class="nav-item">
            ...
            <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-12">
              ...
              <div class="border-bottom pb-3 mb-3">
                <div class="d-flex flex-column gap-1">
                  <h1 class="mb-0 h2 fw-bold">Payment Setting</h1>
                  <!-- Breadcrumb -->
            ...
            <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <p class="mb-4">Enter your PayPal email address below to accept payments from students.</p>
                  <!-- Form -->
                  <form>
                    <div class="mb-3">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form>
                    <div class="mb-3">
                      <label for="stripeEmail" class="form-label">Stripe Email Address</label>
