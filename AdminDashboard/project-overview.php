...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/project-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:37 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    ...
    <link rel="canonical" href="project-overview.html" />
    <title>Project Overview | Geeks - Academy Admin Template</title>
  </head>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <p>
                      ...
                      Vivamus pretium laoreet massa eu euismod. Nunc accumsan id odio sed luctus. Suspendisse a lacus sed ex consequat interdum quis non eros. Lorem ipsum dolor sit amet, consectetur
                      adipisicing elit. Debitis labore nam fuga sapiente vel iste animiicta ab at placeat sint.
                    </p>
                ...
                <div class="card">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-12">
                      <div class="d-flex align-items-center justify-content-between p-4 flex-row gap-3">
                        <div>
            ...
            <div class="col-md-12 col-xl-4 col-12">
              <div class="d-flex flex-column gap-4">
                ...
                <div class="card bg-primary border-primary">
                  <!-- card body  -->
                  <div class="card-body card-body d-flex flex-column gap-8">
                    <h4 class="card-title text-white mb-0">Launch Date</h4>

                    <!-- dropdown  -->
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="d-flex flex-column gap-1">
                        <h1 class="display-4 text-white mb-0">121 Days</h1>
