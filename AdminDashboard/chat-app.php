...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/chat-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:44 GMT -->
<head>
        <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/css/theme.min.css">
        ...
        <link rel="canonical" href="chat-app.html">
        <title>Chat Application | Geeks - Bootstrap 5 Admin Dashboard Template</title>
    </head>
                                                            ...
                                                            <a href="#" class="text-link contacts-link">
                                                                ...
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="ms-2">
                                                                        ...
                                                                        <img src="assets/images/png/dot-move.png" alt="" class="ms-1">
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="#" class="text-link">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center py-3 px-4">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="avatar avatar-md avatar-indicators avatar-away">
                                                                        <img src="assets/images/avatar/avatar-21.jpg" alt="" class="rounded-circle">
                                                                    </div>
                                                                    <!-- media body -->
                                                                    <div class="ms-2">
                                ...
                                <div class="bg-white border-top border-bottom px-4 py-3 sticky-top">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <a href="#" class="text-link texttooltip" data-template="adduser">
                                            ...
                                            <div class="d-flex">
                                                <div class="card mt-2 rounded-top-md-left-0">
                                                    <div class="card-body p-3">
                                                        <p class="mb-0 text-dark">I just start Bootstrap, SCSS and Gulp development & setup github repository. simple example content</p>
                                                    </div>
                                                </div>
                                                <div class="ms-2 mt-2">
                                                    <!-- dropdown -->
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="card mt-2 rounded-top-md-end-0 bg-primary text-white">
                                                        ...
                                                        <div class="card-body text-start p-3">
                                                            <p class="mb-0">I just start Bootstrap, SCSS and Gulp development & setup github repository.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-2 mt-2">
                                                    <!-- dropdown -->
                                                    <div class="dropdown dropend">
                                                        <a class="text-link" href="#" role="button" id="dropdownMenuLinkThree" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <i class="fe fe-more-vertical"></i>
                                                        </a>
                                            ...
                                            <div class="me-3 text-end">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <div class="me-2 mt-2">
                                                        <!-- dropdown -->
                                                        <div class="dropdown dropstart">
                                                            <a class="text-link" href="#" role="button" id="dropdownMenuLinkOne" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                <i class="fe fe-more-vertical"></i>
                                                            </a>
                                                            <!-- dropdown menu -->
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkOne">
                                                                <a class="dropdown-item" href="#">
                                                                    <i class="fe fe-copy dropdown-item-icon"></i>
                                                                    Copy
                                                                </a>
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-2 mt-2">
                                                    <!-- dropdown -->
                                                    <div class="dropdown dropend">
                                                        <a class="text-link" href="#" role="button" id="dropdownMenuLinkFour" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <i class="fe fe-more-vertical"></i>
                                                        </a>
                                            ...
                                            <div class="me-3 text-end">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <div class="me-2 mt-2">
                                                        <!-- dropdown -->
                                                        <div class="dropdown dropstart">
                                                            <a class="text-link" href="#" role="button" id="dropdownMenuLinkSix" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                <i class="fe fe-more-vertical"></i>
                                                            </a>
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkSix">
                                                                <a class="dropdown-item" href="#">
                                                                    <i class="fe fe-copy dropdown-item-icon"></i>
                                                                    Copy
                                                                </a>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/chat-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:45 GMT -->
</html>
