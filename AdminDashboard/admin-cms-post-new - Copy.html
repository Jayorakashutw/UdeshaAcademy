...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/admin-cms-post-new.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:35 GMT -->
...
<head>
    ...
    <link rel="canonical" href="admin-cms-post-new.html" />
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navCMS" class="collapse  show " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  active " href="admin-cms-post-new.html">New Post</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="border-bottom pb-3 mb-3 d-flex flex-column flex-md-row gap-3 align-items-md-center justify-content-between">
                            ...
                            <div>
                                <a href="#" class="btn btn-outline-secondary">Back to All Post</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-9 col-lg-8 col-md-12 col-12">
                        ...
                        <div class="card border-0">
                            ...
                            <form class="needs-validation" novalidate>
                                <!-- Card body -->
                                <div class="card-body">
                                    <input type="radio" class="btn-check mb-1 mb-md-0" name="options" id="option1" autocomplete="off" />
                                    <label class="btn btn-outline-secondary" for="option1">
                    <i class="fe fe-image me-1"></i>
                    Photo
                  </label>

                                    <input type="radio" class="btn-check mb-1 mb-md-0" name="options" id="option2" autocomplete="off" />
                                    <label class="btn btn-outline-secondary" for="option2">
                    <i class="fe fe-video me-1"></i>
                    Video
                  </label>
                                    <input type="radio" class="btn-check mb-1 mb-md-0" name="options" id="option3" autocomplete="off" />
                                    <label class="btn btn-outline-secondary" for="option3">Quote</label>
                                    <input type="radio" class="btn-check mb-1 mb-md-0" name="options" id="option4" autocomplete="off" />
                                    <label class="btn btn-outline-secondary" for="option4">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input type="text" id="selectDate" class="form-control text-dark flatpickr" placeholder="Select Date" required />
                                                <div class="invalid-feedback">Please enter valid date.</div>
                                            </div>
                                            <div class="mb-3 col-md-9">
                                                <!-- Title -->
                                                <label for="postTitle" class="form-label">Title</label>
                                                <input type="text" id="postTitle" class="form-control text-dark" placeholder="Post Title" required />
                            ...
                            <div class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <h5 class="mb-0">Jul 30, 2:21 PM</h5>
                                    </li>
                                    <li class="list-group-item">
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/admin-cms-post-new.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:36 GMT -->
