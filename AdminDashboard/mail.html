...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/mail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:45 GMT -->
<head>
...
<link rel="stylesheet" href="assets/css/theme.min.css">
  ...
  <link rel="canonical" href="mail.html" />
  <title>Mail | Geeks - Bootstrap 5 Admin Dashboard Template</title>
</head>
                      ...
                      <ul class="navbar-nav flex-column w-100">
                        <li class="d-grid mb-4">
                          <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#composeMailModal">Compose New Email</a>
                        </li>
                ...
                <div class="col-xxl-10 col-xl-9 col-12">
                  <div class="card-header p-4">
                    <div class="d-md-flex justify-content-between align-items-center">
                      <div class="d-flex flex-wrap gap-2 mb-2 mb-md-0">
                        ...
                        <div class="dropdown">
                          <a href="#" class="btn btn-outline-secondary btn-icon" id="dropdownMenuButton2"
                  ...
                  <div>
                    ...
                    <div class="list-group list-group-flush list-group-mail">
                      <!-- list group itme -->
                      <div class="list-group-item list-group-item-action px-4 list-mail">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="list-title">
                              <a class="fw-semibold text-dark" href="mail-details.html">Material UI</a>
                            </div>
                            <!-- text -->
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 fw-semibold text-dark list-text">
                                  Start working on Material UI Design layouts encourage consistency across platforms,
                                  environments, and screen sizes by using uniform elements and spacing.
                                </p>
                              </a>
                            </div>
                            <!-- badge -->
                        ...
                        <div class="actions-mail">
                          <a href="#">
                            <span class="fe fe-archive" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Archive"></span>
                          </a>
                          <a href="#">
                            <span class="fe fe-trash-2" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Delete"></span>
                          </a>
                          <a href="#">
                            <span class="fe fe-mail" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Read"></span>
                          </a>
                          <a href="#">
                            <span class="fe fe-eye-off" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Hidden Email"></span>
                          </a>
                        </div>
                      </div>
                      <!-- list group item -->
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  New Mobile Usability issues detected for site To fix this error, make sure the pages
                                  use relative width and position values for CSS elements, and make sure images
                                  can scale as well.
                                </p>
                              </a>
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail bg-light">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listThree" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  Get conversions by sampling product features in your blog amet consectetur adipisicing
                                  elit. Quibusdam aut soluta repellendus culpa voluptatibus quam rerum
                                  dignissimos minus repellat? Aliquid eius commodi maiores tempora....
                                </p>
                              </a>
                            </div>
                            <!-- badge -->
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail bg-light">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listFour" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  See Jitu and other people s connections, experience lorem ipsum dolor sit amet
                                  consectetur adipisicing elit. Minima atque beatae nisi illo consequatur omnis
                                  reprehenderit iste porro, praesentium animi..
                                </p>
                              </a>
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listFive" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            <!-- title -->
                            <div class="list-title">
                              <a href="mail-details.html" class="text-dark fw-semibold">Bootstrap Themes</a>
                            </div>
                            <!-- text -->
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text fw-semibold text-dark">
                                  [Bootstrap Themes] New order (89153)! You ve received the following consectetur
                                  adipisicing elit. Sequi sed dolor repellat reprehenderit officia est sint cupiditate
                                  esse error quo dolore, non ab voluptates?
                                </p>
                              </a>
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail bg-light">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listSix" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  NEW two week crash course: Grow Your Creative Business lorem ipsum dolor sit amet
                                  consectetur adipisicing elit. Quod perspiciatis excepturi nihil earum
                                  exercitationem. Deserunt expedita nostrum illum facilis incidunt delectus veniam!
                                </p>
                              </a>
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail bg-light">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listSeven" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  Weekly account summary from Mailchimp. Here are your weekly stats ipsum dolor sit,
                                  amet consectetur adipisicing elit. Quisquam sunt aliquam, molestiae sapiente eos
                                  error quam maxime distinctio ea, aut eveniet libero!.
                                </p>
                              </a>
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail bg-light">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listEight" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  theme js files aren't working. Hello anita, I think you need to use amet consectetur
                                  adipisicing elit. At ea nesciunt eos quod, amet culpa veritatis maxime odit.
                                  Doloribus facilis, omnis totam nisi nulla voluptatem. ...
                                </p>
                              </a>
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail bg-light">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listNine" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  Introducing Substack Local, for a new generation of local news lorem ipsum dolor sit
                                  amet consectetur adipisicing elit. Possimus veritatis hic minima architecto,
                                  quasi suscipit.
                                </p>
                              </a>
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listTen" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            <!-- title -->
                            <div class="list-title">
                              <a href="mail-details.html" class="fw-semibold text-dark">Google Analytics</a>
                            </div>
                            <!-- text -->
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text fw-semibold text-dark">
                                  Remember to set up today for the future of Google Analytics sit amet consectetur
                                  adipisicing elit. Repellendus, asperiores veritatis. Reiciendis optio ex nisi, odit
                                  id atque ipsum iusto obcaecati earum.
                                </p>
                              </a>
                            </div>
                            <!-- badge -->
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail bg-light">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listEleven" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  New comment on Designing The Perfect Accordion UI Design in Figma" Lorem, ipsum dolor
                                  sit amet consectetur adipisicing elit. Saepe at in excepturi quos ipsam atque
                                  odit.
                                </p>
                              </a>
                            </div>
                      ...
                      <div class="list-group-item list-group-item-action px-4 list-mail bg-light">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="me-2">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" id="listTwelve" />
                            </div>
                          </div>
                          <!-- rating -->
                          <div class="me-4">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                              <a href="mail-details.html">
                                <p class="mb-0 list-text">
                                  @getcodescandy, check out the notifications you have on Twitter Lorem, ipsum dolor sit
                                  amet consectetur adipisicing elit. Saepe at in excepturi quos ipsam atque
                                  odit.
                                </p>
                              </a>
                            </div>
                  ...
                  <div class="card-footer">
                    <div class="d-flex align-items-center justify-content-between">
                      ...
                      <div>
                        <button type="button" class="btn btn-outline-secondary btn-icon" data-bs-toggle="tooltip"
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard/mail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:49:46 GMT -->
</html>