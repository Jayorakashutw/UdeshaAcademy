...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/linked-accounts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:49 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  ...
  <link rel="canonical" href="linked-accounts.html" />
  ...
  <nav class="navbar navbar-expand-lg sidenav sidenav-navbar">
    ...
    <div class="db-content">
        <div class="container mb-4">
           <div class="row mb-5">
               <div class="col-12">
                  <h1 class="h2 mb-0">Linked Accounts</h1>
                </div>
            </div>
           <div class="row">
           <div class="col-12">
                ...
                <div class="card-body">
                    <div class="mb-5 d-md-flex">
                        ...
                        <span>
                            ...
                            <a href="#" class="btn btn-dark btn-sm">Remove my Facebook Account</a>
                        </span>
                    </div>
                    <!-- Google -->
                    <div class="mb-5 d-md-flex border-top pt-5">
                        ...
                        <span>
                            ...
                            <p>Enable one-click login and receive more personalized course recommendations.</p>
                            <a href="#" class="btn btn-outline-secondary btn-sm">Link my Google Account</a>
                        </span>
                    </div>
                    ...
                    <div class="mb-5 d-md-flex border-top pt-5">
                        ...
                        <div>
                            ...
                            <p>Enable one-click login and receive more personalized course recommendations.</p>
                            <a href="#" class="btn btn-outline-secondary btn-sm">Link my Github Account</a>
                        </div>
                    </div>
                    ...
                    <div class="mb-5 d-md-flex border-top pt-5">
                        <div>
                            <span class="color-twitter me-3 align-text-top">
