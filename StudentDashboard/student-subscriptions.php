...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/student-subscriptions.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:29 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="student-subscriptions.html" />

    <title>Dashboard Student Subscription| Geeks - Bootstrap 5 Template</title>
  </head>
  ...
  <nav class="navbar navbar-expand-lg sidenav sidenav-navbar">
    ...
    <div class="db-content">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12">
            <h1 class="mb-0 h2">Subscriptions</h1>
          </div>
        </div>
        <div class="row mb-5">
          <div class="col-12">
