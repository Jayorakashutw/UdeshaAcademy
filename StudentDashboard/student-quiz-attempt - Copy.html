...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/student-quiz-attempt.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:33 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="student-quiz-attempt.html" />
        ...
        <div class="row mb-6">
          <div class="col-12">
            <div class="d-flex flex-row align-items-center justify-content-between">
              <h1 class="h2 mb-0">Quizzes Attempt</h1>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div>
                          <a href="#">
                            <h5 class="mb-1">How to easily create a website with React</h5>
                          </a>
                          <small>20 June, 2022, 12:49 pm</small>
                        </div>
                      </td>
                      <td>25</td>
                      <td>9</td>
                    ...
                    <tr>
                      <td>
                        <div>
                          <a href="#">
                            <h5 class="mb-1">The Python Course: build web application</h5>
                          </a>
                          <small>10 June, 2022, 12:49 pm</small>
                        </div>
                      </td>
                      <td>40</td>
                      <td>20</td>
                      <td>20</td>
                      <td>50(50%)</td>
                      <td><span class="badge bg-warning-soft">Pending</span></td>
                    </tr>
                    <tr>
                      <td>
                        <div>
                          <a href="#">
                            <h5 class="mb-1">Angular - the complete guide for beginner</h5>
                          </a>
                          <small>08 June, 2022, 12:49 pm</small>
                        </div>
                      </td>
                      <td>20</td>
                      <td>20</td>
                    ...
                    <tr>
                      <td>
                        <div>
                          <a href="#">
                            <h5 class="mb-1">Wordpress: complete WordPress theme & plugin development</h5>
                          </a>
                          <small>5 June, 2022, 12:49 pm</small>
                        </div>
                      </td>
                      <td>25</td>
                      <td>9</td>
                    ...
                    <tr>
                      <td>
                        <div>
                          <a href="#">
                            <h5 class="mb-1">CSS: ultimate CSS course from beginner to advanced</h5>
                          </a>
                          <small>4 June, 2022, 12:49 pm</small>
                        </div>
                      </td>
                      <td>25</td>
                      <td>9</td>
