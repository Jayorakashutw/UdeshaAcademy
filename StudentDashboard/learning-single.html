...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/learning-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:35 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="learning-single.html" />

    <title>Dashboard Learning Single| Geeks - Bootstrap 5 Template</title>
  </head>
              ...
              <div class="card-body d-flex flex-column gap-2 gap-md-4">
                <div class="row align-items-center gy-3 gy-lg-0">
                  <div class="col-md-2 col-12">
                    <a href="#!"><img src="../assets/images/course/course-html.jpg" alt="course" class="rounded img-fluid" /></a>
                  </div>
                  <div class="col-md-9 col-12">
                    <div class="d-flex flex-column gap-2">
                      <h2 class="mb-0"><a href="#!" class="text-inherit">Introduction to HTML</a></h2>
                        ...
                        <span class="d-flex flex-row gap-2 align-items-center">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                              ...
                              fill="url(#paint0_linear_8175_5853)"></path>
                            <defs>
                ...
                <div class="d-flex flex-column gap-3">
                  <span class="fw-medium">Learn the basics of HTML, including tags, attributes, and structure.</span>
                  <div class="d-flex flex-column gap-2">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                      <span>1 of 5 lessons completed...</span>
