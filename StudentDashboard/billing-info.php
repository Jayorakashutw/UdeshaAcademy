...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/billing-info.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:31 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="billing-info.html" />

    <title>Dashboard Billing Info| Geeks - Bootstrap 5 Template</title>
  </head>
  ...
  <nav class="navbar navbar-expand-lg sidenav sidenav-navbar">
    ...
    <div class="db-content">
      <div class="container mb-4">
        <div class="row mb-5">
          <div class="col-12">
            <h1 class="mb-0 h2">Billing Info</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <div class="mb-lg-0 mb-3">
                  ...
                  <span>Changes to your billing infomration will take effect starting with scheduled payment and will be refelected on your next invoice.</span>
                </div>
              </div>
              <!-- Card body -->
              <div class="card-body">
                      ...
                      <div class="col">
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="customRadio2">
                            <span class="h4">Billing Address #2</span>
                            <span class="d-block">1901 Thornridge Cir. Shiloh, Hawaii 81063</span>
                          </label>
                        </div>
                      </div>
                ...
                <p class="mb-0">Your text location determines the taxes that are applied to yout bill.</p>
                <a href="#">How do I correct my tax location?</a>
              </div>
            </div>
          </div>
        </div>
