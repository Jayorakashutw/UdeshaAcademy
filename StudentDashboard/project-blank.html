...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/project-blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:35 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="project-blank.html" />

    <title>Dashboard Project Blank| Geeks - Bootstrap 5 Template</title>
  </head>
        ...
        <div class="row">
          <div class="col-12">
            <div class="border-dashed py-6 text-center rounded-3 px-4 px-md-7 px-lg-0">
              ...
              <div>
                <a href="dashboard-project.html" class="btn btn-success">Start Projects</a>
              </div>
            </div>
          </div>
        </div>
