...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/instructor-students.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:28 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="instructor-students.html" />

    <title>Instructor Orders| Geeks - Bootstrap 5 Template</title>
  </head>
    ...
    <div class="db-content">
      <div class="container mb-4">
        <div class="row mb-5">
          <div class="col-12">
            <div>
              <h1 class="h2 mb-0">My Students</h1>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-2">
            <div class="d-flex justify-content-lg-end">
              <div class="nav btn-group flex-nowrap" role="tablist">
                <button class="btn btn-outline-secondary active btn-icon" data-bs-toggle="tab" data-bs-target="#tabPaneGrid" role="tab" aria-controls="tabPaneGrid" aria-selected="true">
                  <span class="fe fe-grid"></span>
                </button>
                <button class="btn btn-outline-secondary btn-icon" data-bs-toggle="tab" data-bs-target="#tabPaneList" role="tab" aria-controls="tabPaneList" aria-selected="false">
                ...
                <div class="row">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-3.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
                          <h4 class="mb-1">Wade Warren</h4>
                          <p class="mb-0">
                            <i class="fe fe-map-pin me-1"></i>
                            United States
                          </p>
                          <a href="#" class="btn btn-sm btn-outline-secondary mt-3">Message</a>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-2.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-1.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-5.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-10.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-4.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-6.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-8.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
                  ...
                  <div class="col-lg-4 col-md-6 col-12 d-none d-lg-block">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <img src="../assets/images/avatar/avatar-9.jpg" class="rounded-circle avatar-xl mb-3" alt="avatar" />
