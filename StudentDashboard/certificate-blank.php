...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/certificate-blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 05:48:33 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8" />
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    ...
    <link rel="canonical" href="certificate-blank.html" />

    <title>Dashboard Certificate Blank| Geeks - Bootstrap 5 Template</title>
  </head>
        ...
        <div class="row mb-5">
          <div class="col-12">
            <div class="d-flex flex-row align-items-center justify-content-between">
              <h1 class="h2 mb-0">Certificate</h1>
                ...
                <div class="col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
                  <div class="d-flex flex-column gap-4">
                    ...
                    <div class="d-flex flex-column gap-2">
                      <h3 class="mb-0 h2">Browse Our Certificate Courses</h3>
                      <p class="mb-0">
                    ...
                    <div>
                      <a href="#!" class="btn btn-dark">Explore Our Certificate</a>
                    </div>
                  </div>
                </div>
              </div>
